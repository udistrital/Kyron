...
set_include_path('blocks//reportico/script/reportico');
...
class reportico extends reportico_object
{
    ...
    var $reportico_url_path = 'blocks//reportico/script/reportico';
    // Path to Reportico runner for AJAX use or standalone mode
    var $url_path_to_reportico_runner = 'blocks//reportico/script/reportico/run.php';
    // Path to frameworks assets folder
    var $url_path_to_assets = 'blocks//reportico/script/reportico';
    ...
    var $url_path_to_calling_script = 'blocks//reportico/script/reportico';
