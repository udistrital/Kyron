...
$cadena_sql = $this->sql->cadena_sql("buscarTablas", $_REQUEST["T1"]);
//var_dump($_REQUEST);
                            ...
                            <tr 
                                ...
                                <td class='  sorting_1'>
                                	<a href='
	                                    ...
	                                    $variable .="&documento=".$value['documento'];
	                                    //$variable.="&nombre_tabla=".$nombre_tabla_bd;
                                ...
                                <td><?php echo $value['fecha_retiro']; ?></td>                                                                   
                            </tr>
