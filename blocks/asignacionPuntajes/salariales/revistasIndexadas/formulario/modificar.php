...
// 			$atributos ['cadena_sql'] = $this->miSql->getCadenaSql ("pais" , $_REQUEST['contextoRevista']);
...
// 			// ----------------FIN CONTROL: Lista País--------------------------------------------------------
			...
			$atributos ['anchoCaja'] = 60;
			$atributos ['miEvento'] = '';
			$atributos ['cadena_sql'] = $cadenaSql = $this->miSql->getCadenaSql ( 'categoria_revista', $_REQUEST['contextoRevista'] );
...
// 			// ----------------FIN CONTROL: Campo de Texto Fecha Publicación Revista--------------------------------------------------------
	...
	// 			------------------Fin Division para los botones-------------------------
			...
			echo $this->miFormulario->marcoAgrupacion ( 'fin' );
				...
				$valorCodificado .= "&id_revista_indexada=".$_REQUEST['id_revista_indexada'];
