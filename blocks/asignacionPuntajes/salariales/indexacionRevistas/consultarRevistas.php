...
var_dump($resultadoIndexadas);exit;
...
{	
    //-----------------Inicio de Conjunto de Controles----------------------------------------
        ...
        for($i=0;$i<count($resultadoIndexadas);$i++)
        {
            ...
            $variable.= "&identificacion=" .$resultadoIndexadas[$i][0];
            $variable.= "&idIndexacion=" .$resultadoIndexadas[$i][1];
            $variable = $this->miConfigurador->fabricaConexiones->crypto->codificar_url($variable, $directorio);
            
            $mostrarHtml = "<tr>
                    <td><center>".$resultadoIndexadas[$i][0]."</center></td>
                    <td><center>".$resultadoIndexadas[$i][12]." ".$resultadoIndexadas[$i][13]."</center></td>
                    <td><center>".$resultadoIndexadas[$i][2]."</center></td>
                    <td><center>".$resultadoIndexadas[$i][3]."</center></td>
                    <td><center>".$resultadoIndexadas[$i][14]."</center></td>
