...
$id_indexacion = $_REQUEST ['idIndexacion'];

$cadena_sql = $this->sql->cadena_sql ( "consultarRevistas", $id_indexacion );
$resultadoIndexacion = $esteRecursoDB->ejecutarAcceso ( $cadena_sql, "busqueda" );

if($resultadoIndexacion [0] ['revista_tipo']==2){


	$Internacional = "display:block";
	$Nacional = "display:none";
 	
 	$paisInternacional = $resultadoIndexacion [0] ['pais_publicacion'];
	

}else if($resultadoIndexacion [0] ['revista_tipo']==1){
...
?>
    <?php
				...
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultadoIndexacion [0] ['revista_nombre'];
				...
				$atributos ["tabIndex"] = $tab ++;
				$atributos ["obligatorio"] = true;
				$atributos ["seleccion"] = $resultadoIndexacion [0] ['revista_tipo'];
				$atributos ["evento"] = 2;
				$atributos ["columnas"] = "1";
				...
				
				{
					...
					$atributos ["tabIndex"] = $tab ++;
					$atributos ["obligatorio"] = true;
					$atributos ["seleccion"] = $resultadoIndexacion [0] ['revista_indexacion'];
					$atributos ["evento"] = 2;
					$atributos ["columnas"] = "1";
					$atributos ["limitar"] = false;
					$atributos ["tamanno"] = 1;
				...
				$atributos ["tabIndex"] = $tab ++;
				$atributos ["obligatorio"] = true;
				$atributos ["seleccion"] = $paisInternacional;
				$atributos ["evento"] = 2;
				$atributos ["columnas"] = "1";
				$atributos ["limitar"] = false;
				$atributos ["tamanno"] = 1;
				...
				$atributos ["tabIndex"] = $tab ++;
				$atributos ["obligatorio"] = true;
				$atributos ["seleccion"] =$resultadoIndexacion [0] ['item_nombre'];
				$atributos ["evento"] = 2;
				$atributos ["columnas"] = "1";
				$atributos ["limitar"] = false;
				$atributos ["tamanno"] = 1;
				...
				$atributos ["estilo"] = "jqueryui";
				$atributos ["anchoEtiqueta"] = 350;
				$atributos ["validar"] = "required, min[1], minSize[10], maxSize[15]";
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultadoIndexacion [0] ['numero_issn'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["valor"] = $resultadoIndexacion [0] ['anno_publicacion'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultadoIndexacion [0] ['volumen_revista'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["validar"] = "required, custom[onlyNumberSp], min[1], maxSize[30]";
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultadoIndexacion [0] ['numero_volumen'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultadoIndexacion [0] ['paginas_revista'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["validar"] = "required, minSize[6], maxSize[2000]";
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultadoIndexacion [0] ['titulo_articulo'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultadoIndexacion [0] ['numero_autores'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultadoIndexacion [0] ['numero_autores_ud'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["validar"] = "required";
				$atributos ["categoria"] = "fecha";
				$atributos ["valor"] = $resultadoIndexacion [0] ['fecha_publicacion'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultadoIndexacion [0] ['acta_numero'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["validar"] = "required";
				$atributos ["categoria"] = "fecha";
				$atributos ["valor"] = $resultadoIndexacion [0] ['fecha_acto'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultadoIndexacion [0] ['numero_caso'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultadoIndexacion [0] ['puntaje'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
                ...
                $atributos["validar"]="required";
                $atributos["categoria"]="";
                $atributos ["valor"] = $resultadoIndexacion [0] ['detalledocencia'];
