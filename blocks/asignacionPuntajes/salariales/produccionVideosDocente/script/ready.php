 ...
 */
 ...
 $('#<?php echo $this->campoSeguro('universidadEvaluador1')?>').width(300);
...
$('#<?php echo $this->campoSeguro('universidadEvaluador2')?>').width(300);
...
$('#<?php echo $this->campoSeguro('universidadEvaluador3')?>').width(300);
