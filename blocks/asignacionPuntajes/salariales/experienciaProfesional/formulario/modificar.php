...
class FormularioModificar {
	...
	function formulario() {
		...
		$_REQUEST['normatividad'] =  $resultadoExperienciaProfesional[0]['normatividad'];
...
// 					unset ( $atributos );
					...
					// ----------------INICIO CONTROL: Campo de Texto Cargo--------------------------------------------------------
					$esteCampo = 'cargo';
					$atributos ['id'] = $esteCampo;
					$atributos ['nombre'] = $esteCampo;
					$atributos ['tipo'] = 'text';
					...
					$atributos ['tabIndex'] = $tab;
					$atributos ['etiqueta'] = $this->lenguaje->getCadena ( $esteCampo );
					$atributos ['validar'] = 'required, maxSize[50], minSize[6]';
					...
					echo $this->miFormulario->campoCuadroTexto ( $atributos );
					unset ( $atributos );
					// ----------------FIN CONTROL: Campo de Texto Cargo--------------------------------------------------------
