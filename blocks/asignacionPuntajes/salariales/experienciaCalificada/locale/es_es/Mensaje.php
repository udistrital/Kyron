...
$this->idioma["tabConsultar"] = "Consultar Experiencia Calificada";
$this->idioma["tabIngresar"] = "Ingresar Experiencia Calificada";
//////////////////////////////////////////////////////////////

//************ MENSAJES *********
$this->idioma["mensajeActualizar"] =  "Actualización Exitosa </br> Han sido actualizados los datos de la Experiencia Calificada <br>";
$this->idioma["mensajeRegistro"] =  "Registro Exitoso.<br> Se ha registrado la Experiencia Calificada para el docente <br>" ;
$this->idioma["mensajeError"] =  "Error al tratar de registrar la Experiencia Calificada.";
$this->idioma["mensajeNoRegistros"] =  "No Se Encontraron  </br> Registros de Experiencia Calificada </br> Para los Criterios Ingresados";
$this->idioma["mensajeNoActualizo"] =  "Error al tratar de actualizar </br>el registro de Experiencia Calificada Para el Docente </br>";
/////////////////////////////////

//* SECCIÓN ELEMENTOS QUE SU NOMBRE POSIBLEMENTE VARIA DENTRO DEL FORMULARIO *//

$this->idioma["annio"] = "Año de Experiencia";
...
$this->idioma['experienciaCalificada'] = '';
$this->idioma['experienciaCalificadaRegistrar'] = '';
$this->idioma['experienciaCalificadaModificar'] = '';
?>
