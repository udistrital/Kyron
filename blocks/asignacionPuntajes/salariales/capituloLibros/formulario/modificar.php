<?php
namespace asignacionPuntajes\salariales\capituloLibros\formulario;
...
class FormularioModificar {
	...
	function formulario() {
		...
		$cadena_sql = $this->miSql->getCadenaSql ( "consultarCapitulo", $datos );
		...
		$_REQUEST['nombreCapitulo'] =  $resultado[0]['titulo_capitulo'];
		...
		$_REQUEST['volumenLibro'] =  $resultado[0]['volumen'];
		$_REQUEST['numeroAutoresCapitulo'] =  $resultado[0]['numero_autores_capitulo'];
		$_REQUEST['numeroAutoresCapituloUniversidad'] =  $resultado[0]['numero_autores_capitulo_ud'];
		$_REQUEST['numeroAutoresLibro'] =  $resultado[0]['numero_autores_libro'];
		$_REQUEST['numeroAutoresLibroUniversidad'] =  $resultado[0]['numero_autores_libro_ud'];
		...
		// ---------------- FIN CONTROL: Inicio Marco --------------------------------------------------------
			...
			// ----------------INICIO CONTROL: Campo de Texto Nombre del Capitulo--------------------------------------------------------
			$esteCampo = 'nombreCapitulo';
			$atributos ['id'] = $esteCampo;
			$atributos ['nombre'] = $esteCampo;
			$atributos ['tipo'] = 'text';
			$atributos ['estilo'] = 'jqueryui';
			...
			echo $this->miFormulario->campoCuadroTexto ( $atributos );
			unset ( $atributos );
			// ----------------FIN CONTROL: Campo de Texto Nombre del Capitulo--------------------------------------------------------
			...
			// ----------------INICIO CONTROL: Campo de Texto Volumen del Libro--------------------------------------------------------
			$esteCampo = 'volumenLibro';
			$atributos ['id'] = $esteCampo;
			$atributos ['nombre'] = $esteCampo;
			$atributos ['tipo'] = 'text';
			$atributos ['estilo'] = 'jqueryui';
			...
			echo $this->miFormulario->campoCuadroTexto ( $atributos );
			unset ( $atributos );
			// ----------------FIN CONTROL: Campo de Texto Número Volumen del Libro--------------------------------------------------------
			
			// ----------------INICIO CONTROL: Campo de Texto Número Autores del Capítulo--------------------------------------------------------
			$esteCampo = 'numeroAutoresCapitulo';
			$atributos ['id'] = $esteCampo;
			$atributos ['nombre'] = $esteCampo;
			$atributos ['tipo'] = 'text';
			$atributos ['estilo'] = 'jqueryui';
			...
			echo $this->miFormulario->campoCuadroTexto ( $atributos );
			unset ( $atributos );
			// ----------------FIN CONTROL: Campo de Texto Número Autores del Capítulo--------------------------------------------------------
				
			// ----------------INICIO CONTROL: Campo de Texto Número Autores del Capítulo UD--------------------------------------------------------
			$esteCampo = 'numeroAutoresCapituloUniversidad';
			$atributos ['id'] = $esteCampo;
			$atributos ['nombre'] = $esteCampo;
			$atributos ['tipo'] = 'text';
			$atributos ['estilo'] = 'jqueryui';
			...
			echo $this->miFormulario->campoCuadroTexto ( $atributos );
			unset ( $atributos );
			// ----------------FIN CONTROL: Campo de Texto Número Autores del Capítulo UD--------------------------------------------------------
			...
			$esteCampo = 'numeroAutoresLibroUniversidad';
			$atributos ['id'] = $esteCampo;
			$atributos ['nombre'] = $esteCampo;
			$atributos ['tipo'] = 'text';
			$atributos ['estilo'] = 'jqueryui';
