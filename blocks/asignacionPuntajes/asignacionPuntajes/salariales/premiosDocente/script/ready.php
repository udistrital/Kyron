...
$("#premiosDocenteRegistrar").validationEngine({
	promptPosition : "centerRight", 
	scroll: false,
	autoHidePrompt: true,
	autoHideDelay: 2000
...
$(function() {
$("#premiosDocenteRegistrar").submit(function() {
$resultado=$("#premiosDocenteRegistrar").validationEngine("validate");
...
$(function() {
	$("#premiosDocenteModificar").submit(function() {
		$resultado=$("#premiosDocenteModificar").validationEngine("validate");
		if ($resultado) {
			return true;
		}
		return false;
...
$("#premiosDocenteModificar").validationEngine({
	promptPosition : "centerRight", 
	scroll: false,
	autoHidePrompt: true,
	autoHideDelay: 2000
