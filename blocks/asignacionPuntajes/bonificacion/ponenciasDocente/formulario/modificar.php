...
class FormularioModificar {
	...
	function formulario() {
		...
		$datos = array(
				...
				'id_ponencia' => $_REQUEST ['id_ponencia'],
		...
		$_REQUEST['id_ponencia'] =  $resultado[0]['id_ponencia'];
		...
		$_REQUEST['numeroAutores'] =  $resultado[0]['numero_autores'];
		$_REQUEST['numeroAutoresUniversidad'] =  $resultado[0]['numero_autores_ud'];
		$_REQUEST['anno'] =  $resultado[0]['anno'];
		$_REQUEST['categoria'] =  $resultado[0]['contexto'];
		$_REQUEST['evento'] =  $resultado[0]['evento_presentacion'];
		$_REQUEST['institucion'] =  $resultado[0]['institucion_certificadora'];
        ...
        // ----------------INICIO CONTROL: Campo de Texto Año de la Ponencia--------------------------------------------------------
        $esteCampo = "anno";
        $atributos ['nombre'] = $esteCampo;
        $atributos ['id'] = $esteCampo;
        $atributos ['etiqueta'] = $this->lenguaje->getCadena ( $esteCampo );
        ...
        unset ( $atributos );
        // ----------------FIN CONTROL: Campo de Texto Año de la Ponencia--------------------------------------------------------
        ...
        $atributos ['tabIndex'] = $tab;
        $atributos ['etiqueta'] = $this->lenguaje->getCadena ( $esteCampo );
        $atributos ['validar'] = 'required,minSize[6],maxSize[200],custom[onlyLetterSp]';
		...
		echo $this->miFormulario->campoCuadroTexto ( $atributos );
		unset ( $atributos );
		// ----------------FIN CONTROL: Campo de Texto Numero Acta Reseña Crítica--------------------------------------------------------
			
		// ----------------INICIO CONTROL: Campo de Texto Fecha Acta Reseña Crítica--------------------------------------------------------
		$esteCampo = 'fechaActa';
		$atributos ['id'] = $esteCampo;
		$atributos ['nombre'] = $esteCampo;
		$atributos ['tipo'] = 'text';
		...
		echo $this->miFormulario->campoCuadroTexto ( $atributos );
		unset ( $atributos );
		// ----------------FIN CONTROL: Campo de Texto Fecha Acta Reseña Crítica--------------------------------------------------------
			
		// ----------------INICIO CONTROL: Campo de Texto Número Caso Acta Reseña Crítica--------------------------------------------------------
		...
		echo $this->miFormulario->campoCuadroTexto ( $atributos );
		unset ( $atributos );
		// ----------------FIN CONTROL: Campo de Texto Número Caso Acta Reseña Crítica--------------------------------------------------------
			
		// ----------------INICIO CONTROL: Campo de Texto Puntaje Reseña Crítica--------------------------------------------------------
		$esteCampo = 'puntaje';
		$atributos ['id'] = $esteCampo;
		$atributos ['nombre'] = $esteCampo;
		$atributos ['tipo'] = 'text';
		...
		echo $this->miFormulario->campoCuadroTexto ( $atributos );
		unset ( $atributos );
		// ----------------FIN CONTROL: Campo de Texto Puntaje Reseña Crítica--------------------------------------------------------
		...
		// ----------------FIN CONTROL: Campo de Texto Fecha de Normatividad--------------------------------------------------------
				...
				$valorCodificado .= "&id_ponencia=".$_REQUEST['id_ponencia'];
