...
class RegistrarIndexacionRevista {
	...
	function procesarFormulario() {
		...
		// OJOOOOOOOOOO!!!!!!!!!!!!!!!!!!!!!!
		// PONER AQUI la consulta de estudiantes desde polux y contarlos?
		// YA no es necesario volver a consultar, se deja que el usuario pueda cambiarlo,
		// Solo al registro se consulta
