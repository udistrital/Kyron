...
class SqlComunicacionCorta extends sql {
	var $miConfigurador;
	...
	function cadena_sql($tipo, $variable = "") {
		...
		switch ($tipo) {
			...
			case "insertarComunicacion" :
				$cadena_sql = "INSERT INTO docencia.comunicacion_corta( ";
			...
			case "consultarComunicaciones" :
				
				$cadena_sql = "SELECT DISTINCT id_comunicacion_corta, id_revista_docente, ";
				...
				$cadena_sql .= " volumen_revista, numero_volumen, paginas_revista, fecha_publicacion, detalledocencia, puntaje ";
			...
			case "consultarCorta" :
				...
				$cadena_sql .= "id_comunicacion_corta, revista_nombre, revista_tipo, item_nombre,   ";
				...
				$cadena_sql .= "paisnombre, detalledocencia, revista_indexacion ";
				$cadena_sql .= "FROM docencia.dependencia_docente ";
				$cadena_sql .= " JOIN docencia.docente_informacion ON informacion_numeroidentificacion = dependencia_iddocente ";
				$cadena_sql .= "JOIN docencia.comunicacion_corta ON id_revista_docente = dependencia_iddocente ";
				$cadena_sql .= "LEFT JOIN docencia.parametros_indexacion ON item_id = revista_indexacion ";
				$cadena_sql .= "LEFT JOIN docencia.pais_kyron ON paiscodigo = pais_publicacion  ";
				$cadena_sql .= "WHERE id_comunicacion_corta =" . $variable;
				break;
			
			case "actualizarComunicacion" :
				$cadena_sql = "UPDATE ";
				$cadena_sql .= "docencia.comunicacion_corta ";
				$cadena_sql .= "SET ";
				...
				$cadena_sql .= "WHERE ";
				$cadena_sql .= "id_comunicacion_corta ='" . $variable [0] . "' ";
				break;
			/**
			 * Clausulas genéricas.
