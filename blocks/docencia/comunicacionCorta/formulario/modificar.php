...
$id_comunicacion = $_REQUEST ['idComunicacion'];

$cadena_sql = $this->sql->cadena_sql ( "consultarCorta", $id_comunicacion );
$resultadoComunicacion = $esteRecursoDB->ejecutarAcceso ( $cadena_sql, "busqueda" );

if($resultadoComunicacion [0] ['revista_tipo']==2){
...
}else if($resultadoComunicacion [0] ['revista_tipo']==1){


	$Nacional = "display:block";
 	$Internacional = "display:none";
// 	$paisInternacional = $resultadoComunicacion [0] ['country_publication'];
// 	$indexacion=$resultadoComunicacion [0] ['indexation_magazine'];
}
?>
    <?php
				...
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultadoComunicacion [0] ['revista_nombre'];
				...
				$atributos ["tabIndex"] = $tab ++;
				$atributos ["obligatorio"] = true;
				$atributos ["seleccion"] = $resultadoComunicacion [0] ['revista_tipo'];
				$atributos ["evento"] = 2;
				$atributos ["columnas"] = "1";
				...
				
				{
					...
					$atributos ["tabIndex"] = $tab ++;
					$atributos ["obligatorio"] = true;
					$atributos ["seleccion"] = $resultadoComunicacion [0] ['revista_indexacion'];
					$atributos ["evento"] = 2;
					$atributos ["columnas"] = "1";
					$atributos ["limitar"] = false;
					$atributos ["tamanno"] = 1;
				...
				$atributos ["tabIndex"] = $tab ++;
				$atributos ["obligatorio"] = true;
				$atributos ["seleccion"] = $resultadoComunicacion [0] ['paisnombre'];
				$atributos ["evento"] = 2;
				$atributos ["columnas"] = "1";
				$atributos ["limitar"] = false;
				$atributos ["tamanno"] = 1;
				...
				$atributos ["tabIndex"] = $tab ++;
				$atributos ["obligatorio"] = true;
				$atributos ["seleccion"] =$resultadoComunicacion [0] ['item_nombre'] ;
				$atributos ["evento"] = 2;
				$atributos ["columnas"] = "1";
				$atributos ["limitar"] = false;
				$atributos ["tamanno"] = 1;
				...
				$atributos ["estilo"] = "jqueryui";
				$atributos ["anchoEtiqueta"] = 350;
				$atributos ["validar"] = "required, custom[integer], custom[onlyNumberSp], minSize[10], maxSize[15]";
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultadoComunicacion [0] ['numero_issn'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["valor"] = $resultadoComunicacion [0] ['anno_publicacion'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultadoComunicacion [0] ['volumen_revista'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["validar"] = "required, custom[onlyNumberSp], min[1], maxSize[30]";
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultadoComunicacion [0] ['numero_volumen'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultadoComunicacion [0] ['paginas_revista'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["validar"] = "required, minSize[6], maxSize[2000]";
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultadoComunicacion [0] ['titulo_articulo'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultadoComunicacion [0] ['numero_autores'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultadoComunicacion [0] ['numero_autores_ud'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["validar"] = "required";
				$atributos ["categoria"] = "fecha";
				$atributos ["valor"] = $resultadoComunicacion [0] ['fecha_publicacion'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultadoComunicacion [0] ['acta_numero'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["validar"] = "required";
				$atributos ["categoria"] = "fecha";
				$atributos ["valor"] = $resultadoComunicacion [0] ['fecha_acto'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultadoComunicacion [0] ['numero_caso'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultadoComunicacion [0] ['puntaje'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
                                ...
                                $atributos["validar"]="required";
                                $atributos["categoria"]="";
                                $atributos ["valor"] = $resultadoComunicacion [0] ['detalledocencia'];
