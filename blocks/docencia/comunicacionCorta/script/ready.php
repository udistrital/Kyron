...
?>
        ...
        $("#comunicacionCorta").change(function(){
            $("#detalleDocencia").val('');
            ...
            var texto = '';
            $("#comunicacionCorta").find(':input').each(function() {
           ...
           $("#indexacion").change(function(event) 
            {                
                ...
                {                
                    ...
                    case '7':
                        $("#puntaje").attr("class", "ui-widget ui-widget-content ui-corner-all validate[required, custom[number],min[0.1],max[9]]");
                    break;
                    case '8':
                        $("#puntaje").attr("class", "ui-widget ui-widget-content ui-corner-all validate[required, custom[number],min[0.1],max[7.2]]");
                    break;
                    case '9':
                        $("#puntaje").attr("class", "ui-widget ui-widget-content ui-corner-all validate[required, custom[number],min[0.1],max[4.8]]");
                    break;
                    case '10':
                        $("#puntaje").attr("class", "ui-widget ui-widget-content ui-corner-all validate[required, custom[number],min[0.1],max[1.8]]");
                    break;
