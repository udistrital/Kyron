...
$cadena_sql = $this->sql->cadena_sql("consultarTitulos", $arreglo);
...
{	
    //-----------------Inicio de Conjunto de Controles----------------------------------------
        ...
        for($i=0;$i<count($resultadoTitulos);$i++)
        {
            ...
            $variable.= "&identificacion=" .$resultadoTitulos[$i]['id_docente'];
            $variable .= "&idTitulo=" . $resultadoTitulos[$i]['id_titulo'];	
            $variable = $this->miConfigurador->fabricaConexiones->crypto->codificar_url($variable, $directorio);
            
            $mostrarHtml = "<tr>
                    <td><center>".$resultadoTitulos[$i]['id_docente']."</center></td>
                    <td><center>".$resultadoTitulos[$i]['informacion_nombres']." ".$resultadoTitulos[$i]['informacion_apellidos']."</center></td>
                    <td><center>".$resultadoTitulos[$i]['titulo']."</center></td>
                    <td><center>".$resultadoTitulos[$i]['puntaje']."</center></td>
