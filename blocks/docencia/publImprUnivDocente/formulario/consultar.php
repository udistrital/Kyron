...
if ($resultadoExperiencia) {
	...
	echo "<thead>
                <tr>
                   <th>Identificación</th>
                    <th>Nombres</th>
                    <th>Titulo Publicación Impresa</th>
					<th>Fecha de Publicación Impresa</th>
			        <th>ISBN o ISSN</th>
			        <th>Revista Publicación o Nombre libro</th>
	...
	for($i = 0; $i < count ( $resultadoExperiencia ); $i ++) {
		...
		$variable .= "&idPublicacion=" . $resultadoExperiencia [$i] [10];
