...
$cadena_sql = $this->sql->cadena_sql ( "consultarInterpretaciones", $arreglo );
...
if ($resultadoTitulos) {
	...
	echo "<thead>
                <tr>
        			...
        			<th>Autor interpretacion</th>
                    <th>Titulo interpretacion</th>                    
                    <th>Entidad</th>
                    <th>Número presentacion</th>
        			<th>Fecha intepretacion</th>
	...
	for($i = 0; $i < count ( $resultadoTitulos ); $i ++) {
		...
		$variable .= "&idInterpretacion=" . $resultadoTitulos [$i] [12];		
		$variable = $this->miConfigurador->fabricaConexiones->crypto->codificar_url ( $variable, $directorio );
		
		$mostrarHtml = "<tr>
                    <td><center>" . $resultadoTitulos [$i] [0] . "</center></td>
                    <td><center>" . $resultadoTitulos [$i] [10] . " " . $resultadoTitulos [$i] [11] . "</center></td>
