...
{	
    //-----------------Inicio de Conjunto de Controles----------------------------------------
        ...
        for($i=0;$i<count($resultadoTitulos);$i++)
        {
            ...
            $mostrarHtml = "<tr>
                    <td>".$resultadoTitulos[$i][0]."</td>
                    <td>".$resultadoTitulos[$i][1]."</td>
                    <td>".$resultadoTitulos[$i][2]."</td>
                    <td>".$resultadoTitulos[$i][3]."</td>
                    <td>".$resultadoTitulos[$i][4]."</td>
                    <td>".$resultadoTitulos[$i][5]."</td>
                    <td>".$resultadoTitulos[$i][6]."</td>
                    <td>".$resultadoTitulos[$i][7]."</td>
                    <td>".$resultadoTitulos[$i][8]."</td>
                    <td>".$resultadoTitulos[$i][9]."</td>
                    <td>
                        <a href='".$variable."'>                        
