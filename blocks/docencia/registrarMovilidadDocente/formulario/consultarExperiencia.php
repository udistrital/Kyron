...
// var_dump($resultadoExperiencia);exit;
if ($resultadoExperiencia) {
	...
	echo "<thead>
                <tr>
                   <th>Identificación</th>
                    <th>Nombres</th>
                    <th>Dependencia/Entidad Asume Tiquetes</th>
                    <th>Dependencia/Entidad Asume Incripción</th>
                    <th>Dependencia/Entidad Asume Viáticos</th>
	...
	for($i = 0; $i < count ( $resultadoExperiencia ); $i ++) {
		...
		$variable .= "&identificacion=" . $resultadoExperiencia [$i] [7];
		$variable = $this->miConfigurador->fabricaConexiones->crypto->codificar_url ( $variable, $directorio );
		
		$mostrarHtml = "<tr>
                    <td><center>" . $resultadoExperiencia [$i] [0] . "</center></td>
                    <td><center>" . $resultadoExperiencia [$i] [8] . " " . $resultadoExperiencia [$i] [9] . "</center></td>
                    ...
                    <td><center><A HREF=\"" . $resultadoExperiencia [$i] [4] ."\" target='_blank' >".$resultadoExperiencia [$i] [5]."</A></center></td>
                    <td><center><A HREF=\"" . $resultadoExperiencia [$i] [6]."\" target='_blank' >".$resultadoExperiencia [$i] [7]."</A></center></td>
                     <td><center>
                    		<a href='" . $variable . "'>                        
