...
if ($resultadoExperiencia) {
	...
	echo "<thead>
                <tr>
                   <th>Identificación</th>
					...
					<th>Archivo Horario</th>
			        <th>Archivo Syllabus </th>
					 <th>Modificar</th>
                </tr>
            </thead>
            <tbody>";
	...
	for($i = 0; $i < count ( $resultadoExperiencia ); $i ++) {
		...
		$mostrarHtml = "<tr>
                    ...
                    <td><center><A HREF=\"" . $resultadoExperiencia [$i] [4] ."\">".$resultadoExperiencia [$i] [5]."</A></center></td>
                    <td><center><A HREF=\"" . $resultadoExperiencia [$i] [6]."\">".$resultadoExperiencia [$i] [7]."</A></center></td>
                     <td><center>
                    		<a href='" . $variable . "'>                        
