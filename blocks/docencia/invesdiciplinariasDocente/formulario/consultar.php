...
if ($resultadoExperiencia) {
	...
	echo "<thead>
                <tr>
                   <th>Identificación</th>
                    ...
                    <th>Número Investigacón Disciplinaria</th>
					<th>Descripción</th>
	...
	for($i = 0; $i < count ( $resultadoExperiencia ); $i ++) {
		...
		$variable .= "&idInvestigacion=" . $resultadoExperiencia [$i] [7];
		$variable .= "&ruta=" . $resultadoExperiencia [$i] [3];
		$variable .= "&nombre=" . $resultadoExperiencia [$i] [4];
		$variable = $this->miConfigurador->fabricaConexiones->crypto->codificar_url ( $variable, $directorio );
		
		$mostrarHtml = "<tr>
                    <td><center>" . $resultadoExperiencia [$i] [0] . "</center></td>
                    <td><center>" . $resultadoExperiencia [$i] [5] . " " . $resultadoExperiencia [$i] [6] . "</center></td>
                    <td><center>" . $resultadoExperiencia [$i] [1] . "</center></td>
                    <td><center>" . $resultadoExperiencia [$i] [2] . "</center></td>
                    <td><center><A HREF=\"" . $resultadoExperiencia [$i] [3] ."\">".$resultadoExperiencia [$i] [4]."</A></center></td>
                     <td><center>
                    		<a href='" . $variable . "'>                        
