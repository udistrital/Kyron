...
$cadena_sql = $this->sql->cadena_sql ( "consultarInvestigacionModificar", $_REQUEST ['idInvestigacion'] );
...
?>
    <?php
				...
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultado [0] ['num_investigacion'];
				...
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultado [0] ['nombre_soporte'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
