...
if ($resultadoExperiencia) {
	...
	echo "<thead>
                <tr>
                   <th>Identificación</th>
                    <th>Nombres</th>
                    <th>Tipo Obra Artistica</th>
					<th>Titulo de Obra</th>
			        <th>Medio Publicación </th>
					  <th>Fecha de Obra Artistica</th>                    
	...
	for($i = 0; $i < count ( $resultadoExperiencia ); $i ++) {
		...
		$variable .= "&id_obra=" . $resultadoExperiencia [$i] ['id_obras'];
		$variable = $this->miConfigurador->fabricaConexiones->crypto->codificar_url ( $variable, $directorio );
		
		$mostrarHtml = "<tr>
                    <td><center>" . $resultadoExperiencia [$i] [0] . "</center></td>
                    <td><center>" . $resultadoExperiencia [$i] [9] . " " . $resultadoExperiencia [$i] [10] . "</center></td>
