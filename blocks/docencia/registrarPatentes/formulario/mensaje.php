...
echo $this->miFormulario->formulario("inicio",$atributos);
   ...
   //$atributos["estiloEnLinea"]="display:none"; 
	...
	{
            $tipo = 'success';
            $mensaje = "Se agrego un nueva patente para ".$_REQUEST ['docente'].". Presione el botón Continuar.";
            $boton = "continuar";
	...
	{
            $tipo = 'error';
            $mensaje = "No se pudo guardar nueva patente para el docente ".$_REQUEST ['docente'].". Intente de nuevo mas tarde.";
            $boton = "regresar";
	...
	{
           $tipo = 'success';
            $mensaje = "Se actualizo la patente del  Docente  ".$resultadoConsulta[0]['nombres'].". Presione el botón Continuar.";
            $boton = "continuar";
	...
	{
            $tipo = 'error';
            $mensaje = "No se pudo actualizar la información de la patente del docente ".$resultadoConsulta[0]['nombres'].".";
            $boton = "regresar";
