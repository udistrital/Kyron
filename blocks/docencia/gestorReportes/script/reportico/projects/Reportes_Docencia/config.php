...
define('SW_PROJECT_TITLE', 'Reportes Docencia');
...
if (SW_DB_TYPE == "framework") {
    /*
      define('SW_DB_DRIVER', 'pdo_pgsql');
      define('SW_DB_USER','kyron_frame');
      define('SW_DB_PASSWORD', 'kyronDoceTcia2013=OAS');
      define('SW_DB_HOST', '10.20.0.38');
      define('SW_DB_DATABASE', 'kyron'); */
    ...
    define('SW_DB_USER', 'kyron_frame');
    define('SW_DB_PASSWORD', 'kyronFr4m32014=DOC');
    define('SW_DB_HOST', '10.20.0.9');
    define('SW_DB_DATABASE', 'kyron');
}
...
define('PDF_HEADER_IMAGE', 'images/ud.jpg');
