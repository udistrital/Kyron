	...
	function finish ()
	{
		...
		if ( $this->line_count < 1 )
		{
		    ...
		    if ( !get_request_item("printable_html") )
            {
                ...
                {
			        $this->text .= '<div class="swRepBackBox"><a class="swLinkMenu" href="'.$this->query->get_action_url().'?'.$forward.'execute_mode=PREPARE&reportico_session_name='.reportico_session_name().'" title="">&nbsp;</a></div>';
                }
