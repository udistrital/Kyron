...
if ($resultadoExperiencia) {
	...
	echo "<thead>
                <tr>
                   <th>Identificación</th>
					...
					<th>Número de Certificado del Producto</th>
	...
	for($i = 0; $i < count ( $resultadoExperiencia ); $i ++) {
		...
		$cadena_sql = $this->sql->cadena_sql ( "consultarEvaluadores", $resultadoExperiencia [$i] [10] );
		...
		$variable .= "&idTecnSotf=" . $resultadoExperiencia [$i] [10];
		$variable .= "&idEvaluadores=" . $id_evaluador;
		...
		$mostrarHtml = "<tr>
                    ...
                    <td><center>" . $resultadoExperiencia [$i] [11] . "</center></td>
