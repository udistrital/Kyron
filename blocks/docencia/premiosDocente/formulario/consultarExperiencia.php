...
if ($resultadoExperiencia) {
	...
	echo "<thead>
                <tr>
			       ...
			       <th>Pais</th> 
					<th>Ciudad</th>                    
                    <th>Fecha</th>
					<th>Número de Personas Otorgadas</th>
					<th>Año Premiación</th>
	...
	for($i = 0; $i < count ( $resultadoExperiencia ); $i ++) {
		...
		$variable .= "&idpremios=" . $resultadoExperiencia [$i] [15];
		$variable = $this->miConfigurador->fabricaConexiones->crypto->codificar_url ( $variable, $directorio );
		
		$mostrarHtml = "<tr>
                    <td><center>" . $resultadoExperiencia [$i] [0] . "</center></td>
                    <td><center>" . $resultadoExperiencia [$i] [13] . " " . $resultadoExperiencia [$i] [14] . "</center></td>
                    ...
                    <td><center>" . $resultadoExperiencia [$i] [10] . "</center></td>
