...
class SqldescargaInvestigacion extends sql {
	var $miConfigurador;
	...
	function cadena_sql($tipo, $variable = "") {
		...
		switch ($tipo) {
			...
			case "insertarDescarga" :
				
				$cadena_sql = "INSERT INTO docencia.descarga_investigacion( ";
				$cadena_sql .= "numacta_descarga, horas_descarga, ";
				$cadena_sql .= "codigo_descarga, docente_descarga, dependencia_descarga) ";
			...
			case "consultarDescarga" :
				...
				$cadena_sql = "SELECT DISTINCT numacta_descarga, nombre_proyecto, horas_descarga, ";
				$cadena_sql .= "codigo_descarga, docente_descarga, ";
				$cadena_sql .= " informacion_nombres, informacion_apellidos, id_descarga ";
				...
				$cadena_sql .= "JOIN docencia.descarga_investigacion ON docente_descarga = dependencia_iddocente ";
				$cadena_sql .= "JOIN docencia.proyectocurricular ON id_proyecto = dependencia_descarga ";
			...
			case "consultarDescargas" :
				
				$cadena_sql = "SELECT DISTINCT ";
				$cadena_sql .= "dependencia_descarga, horas_descarga, ";
				$cadena_sql .= "codigo_descarga, numacta_descarga, docente_descarga ";
				$cadena_sql .= "FROM docencia.descarga_investigacion ";
				$cadena_sql .= "WHERE id_descarga =" . $variable;
				break;
			
			case "actualizarDescarga" :
				$cadena_sql = "UPDATE ";
				$cadena_sql .= "docencia.descarga_investigacion ";
				$cadena_sql .= "SET ";
				$cadena_sql .= "dependencia_descarga = '" . $variable [1] . "', ";
				$cadena_sql .= "horas_descarga = '" . $variable [2] . "', ";
				$cadena_sql .= "codigo_descarga = '" . $variable [3] . "', ";
				$cadena_sql .= "numacta_descarga = '" . $variable [4] . "' ";
				$cadena_sql .= "WHERE ";
				$cadena_sql .= "id_descarga ='" . $variable [0] . "' ";
				break;
			/**
			 * Clausulas genéricas.
