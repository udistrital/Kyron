...
$cadena_sql = $this->sql->cadena_sql("consultarDescarga", $arreglo);
...
{	
    //-----------------Inicio de Conjunto de Controles----------------------------------------
        ...
        for($i=0;$i<count($resultadoDescarga);$i++)
        {
            $variable = "pagina=".$miPaginaActual; //pendiente la pagina para modificar parametro                                                        
            $variable.= "&opcion=modificar";
            $variable.= "&usuario=" . $miSesion->getSesionUsuarioId();
            $variable.= "&identificacion=" .$resultadoDescarga[$i][4];
            $variable.= "&idDescarga=" .$resultadoDescarga[$i][7];
            $variable = $this->miConfigurador->fabricaConexiones->crypto->codificar_url($variable, $directorio);
            
            $mostrarHtml = "<tr>
                    <td><center>".$resultadoDescarga[$i][4]."</center></td>
                   	<td><center>".$resultadoDescarga[$i][5]." ".$resultadoDescarga[$i][6]."</center></td>
                    <td><center>".$resultadoDescarga[$i][1]."</center></td>
                    <td><center>".$resultadoDescarga[$i][2]."</center></td>
                    <td><center>".$resultadoDescarga[$i][3]."</center></td>
                    <td><center>".$resultadoDescarga[$i][0]."</center></td>
                    <td>
                        <a href='".$variable."'>                        
