...
class SqlexperienciaDocencia extends sql {
	var $miConfigurador;
	...
	function cadena_sql($tipo, $variable = "", $variable1 = "", $variable2 = "") {
		...
		switch ($tipo) {
			...
			case "insertarExperiencia" :
				...
				$cadena_sql = "INSERT INTO docencia.experiencia_docencia( ";
			...
			case "consultarExperienciaModificar" :
				...
				$cadena_sql .= "num_horas, fecha_inicio, fecha_fin, duracion_dias, nume_acta,";
				$cadena_sql .= "fecha_acta, nume_caso, puntaje, detalledocencia ";
				$cadena_sql .= "FROM docencia.experiencia_docencia ";
			...
			case "consultarExperiencia" :
				...
				$cadena_sql .= " informacion_nombres, informacion_apellidos, id_experiencia, detalledocencia ";
				...
				$cadena_sql .= "JOIN docencia.experiencia_docencia ON id_docente = dependencia_iddocente ";
			...
			case "actualizarExperiencia" :
				$cadena_sql = "UPDATE ";
				$cadena_sql .= "docencia.experiencia_docencia ";
				$cadena_sql .= "SET ";
