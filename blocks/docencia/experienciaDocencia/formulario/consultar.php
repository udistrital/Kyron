...
// var_dump($resultadoTitulos); exit;
...
if ($resultadoTitulos) {
	...
	echo "<thead>
                <tr>
			        ...
			        <th>Duración Experiencia<br>(Dias)</th>
	...
	for($i = 0; $i < count ( $resultadoTitulos ); $i ++) {
		...
		$variable .= "&idExperiencia=" . $resultadoTitulos [$i] [13];
		$variable = $this->miConfigurador->fabricaConexiones->crypto->codificar_url ( $variable, $directorio );
		
		$mostrarHtml = "<tr>
                    <td><center>" . $resultadoTitulos [$i] [0] . "</center></td>
                    <td><center>" . $resultadoTitulos [$i] [11] . " " . $resultadoTitulos [$i] [12] . "</center></td>
