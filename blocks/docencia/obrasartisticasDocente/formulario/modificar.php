...
$cadena_sql = $this->sql->cadena_sql ( "consultarObra", $_REQUEST ['idObra'] );
...
switch ($resultadoObra [0] ['tipo_obra']) {
	...
	case '1' :
		...
		if ($resultadoObra [0] ['contexto_obra'] == 1) {
			
			$maxPuntaje = ",max[14]";
		} else if ($resultadoObra [0] ['contexto_obra'] == 2) {
...
?>
    <?php
				...
				$atributos ["validar"] = "required, minSize[1],maxSize[2000]";
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultadoObra [0] ['certifica'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["validar"] = "required";
				$atributos ["categoria"] = "";
				$atributos ["valor"] = $resultadoObra [0] ['anio_obra'];
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
				...
				$atributos ["id"] = $esteCampo;
				$atributos ["tabIndex"] = $tab ++;
				$atributos ["seleccion"] = $resultadoObra [0] ['contexto_obra'];
				$atributos ["evento"] = 2;
				$atributos ["columnas"] = "1";
				$atributos ["limitar"] = false;
				$atributos ["tamanno"] = 1;
				...
				$atributos ["estilo"] = "jqueryui";
				$atributos ["anchoEtiqueta"] = 320;
				$atributos ["validar"] = "required, custom[number],min[0.1]".$maxPuntaje;
				$atributos ["categoria"] = "";
