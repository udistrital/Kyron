...
class SqlExperienciaInvestigacion extends sql {
	var $miConfigurador;
	...
	function cadena_sql($tipo, $variable = "") {
		...
		switch ($tipo) {
			...
			case "experiencia" :
				...
				$cadena_sql = "SELECT id_tipo, descripcion ";
				$cadena_sql .= "FROM docencia.tipo_experiencia_investigacion ";
			...
			case "insertarExperiencia" :
				...
				$cadena_sql = "INSERT INTO docencia.experiencia_investigacion( ";
				$cadena_sql .= "id_docente, entidad, tipo_experiencia,  ";
				$cadena_sql .= "fecha_inicio, fecha_fin, nume_acta, fech_acta, nume_caso, horas_semana, puntaje, otra_entidad, detalleDocencia) ";
			...
			case "consultarInvestigacion" :
				...
				$cadena_sql .= "id_experiencia, id_docente, entidad, otra_entidad, tipo_experiencia, fecha_inicio,  ";
				$cadena_sql .= "fecha_fin, nume_acta, fech_acta, nume_caso, horas_semana, puntaje, detalleDocencia  ";
				$cadena_sql .= "FROM docencia.experiencia_investigacion ";
			...
			case "consultarExperiencia" :
				...
				$cadena_sql .= "case WHEN entidad ='0' THEN otra_entidad
                                 ELSE nombre_universidad END  AS Entidad, ";
				$cadena_sql .= "TE.descripcion, ";
				$cadena_sql .= " fecha_inicio, fecha_fin, nume_acta, fech_acta, nume_caso, horas_semana, puntaje, ";
			...
			case "actualizarExperiencia" :
				$cadena_sql = "UPDATE ";
				$cadena_sql .= "docencia.experiencia_investigacion ";
				$cadena_sql .= "SET ";
				$cadena_sql .= "entidad = '" . $variable [1] . "', ";
				$cadena_sql .= "otra_entidad = '" . $variable [2] . "', ";
				$cadena_sql .= "tipo_experiencia = '" . $variable [3] . "', ";
				$cadena_sql .= "fecha_inicio = '" . $variable [4] . "', ";
				$cadena_sql .= "fecha_fin = '" . $variable [5] . "', ";
				$cadena_sql .= "nume_acta = '" . $variable [6] . "', ";
				$cadena_sql .= "fech_acta = '" . $variable [7] . "', ";
				$cadena_sql .= "nume_caso = '" . $variable [8] . "', ";
				$cadena_sql .= "horas_semana = '" . $variable [9] . "', ";
