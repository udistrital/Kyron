...
?>
        ...
        $("#experienciaInvestigacion").change(function(){
            $("#detalleDocencia").val('');
            var camposForm = [ "entidad", "otraEntidad", "experiencia", "fechaInicio", "fechaFin", "numeActa", "fechaActa", "numeCaso", "horas", "puntaje" ];
            
            var texto = '';
            $("#experienciaInvestigacion").find(':input').each(function() {
                ...
                {                
                    ...
                    if(elemento.value != '')
                    {
                        if(elemento.id == 'entidad' || elemento.id == 'experiencia')
                        {
...
$('input#fechaFin').datepicker('option', 'maxDate', lockDate);
        ...
        var puntaje = ((parseInt(dias)*6)/365);
