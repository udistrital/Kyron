...
$cadena_sql = $this->sql->cadena_sql ( "consultarConvenio", $arreglo );
...
if ($resultadoExperiencia) {
	...
	for($i = 0; $i < count ( $resultadoExperiencia ); $i ++) {
		...
		$variable .= "&idConvenio=" . $resultadoExperiencia [$i] [8];
		$variable .= "&ruta=" . $resultadoExperiencia [$i] [5];
		$variable .= "&nombre=" . $resultadoExperiencia [$i] [4];
		$variable = $this->miConfigurador->fabricaConexiones->crypto->codificar_url ( $variable, $directorio );
		
		$mostrarHtml = "<tr>
                    <td><center>" . $resultadoExperiencia [$i] [0] . "</center></td>
                    <td><center>" . $resultadoExperiencia [$i] [6] . " " . $resultadoExperiencia [$i] [7] . "</center></td>
                    ...
                    <td><center><A HREF=\"" . $resultadoExperiencia [$i] [5] ."\">".$resultadoExperiencia [$i] [4]."</A></center></td>
                    <td><center>
                    		<a href='" . $variable . "'>                        
