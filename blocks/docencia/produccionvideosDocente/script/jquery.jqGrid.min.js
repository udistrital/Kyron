...
display:"none"}),0!==this.grid.bDiv.scrollTop&&(this.grid.bDiv.scrollTop=0));!0===b&&this.p.treeGrid&&(this.p.data=[],this.p._index={})},A=function(){var b=c.p.data.length,d,e,f;d=!1===c.p.keyName||!0===c.p.loadonce?c.p.localReader.id:c.p.keyName;for(e=0;e<b;e++)f=a.jgrid.getAccessor(c.p.data[e],d),void 0===f&&(f=String(e+1)),c.p._index[f]=e},H=function(b,d,e,f,g,k){var l="-1",h="",m;d=d?"display:none;":"";e="ui-widget-content jqgrow ui-row-"+c.p.direction+(e?" "+e:"")+(k?" ui-state-highlight":"");
...
l+'" class="'+e+'"'+(""===d?"":' style="'+d+'"')+h+">"},B=function(b,d,e,f,g){var k=new Date,l="local"!==c.p.datatype&&c.p.loadonce||"xmlstring"===c.p.datatype,h=c.p.xmlReader,m="local"===c.p.datatype?"local":"xml";l&&(c.p.data=[],c.p._index={},c.p.localReader.id="_id_");c.p.reccount=0;if(a.isXMLDoc(b)){-1!==c.p.treeANode||c.p.scroll?e=1<e?e:1:(w.call(c,!1,!0),e=1);var p=a(c),n,q,s=0,B,I=!0===c.p.multiselect?1:0,A=0,y,M=!0===c.p.rownumbers?1:0,J,F=[],K,D={},N,E,G=[],S=!0===c.p.altRows?c.p.altclass:
"",ea;!0===c.p.subGrid&&(A=1,y=a.jgrid.getMethod("addSubGridCell"));h.repeatitems||(F=x(m));J=!1===c.p.keyName?a.isFunction(h.id)?h.id.call(c,b):h.id:c.p.keyName;m=-1===String(J).indexOf("[")?F.length?function(c,b){return a(J,c).text()||b}:function(c,b){return a(h.cell,c).eq(J).text()||b}:function(a,c){return a.getAttribute(J.replace(/[\[\]]/g,""))||c};c.p.userData={};c.p.page=r(a.jgrid.getXmlData(b,h.page),c.p.page);c.p.lastpage=r(a.jgrid.getXmlData(b,h.total),1);c.p.records=r(a.jgrid.getXmlData(b,
h.records));a.isFunction(h.userdata)?c.p.userData=h.userdata.call(c,b)||{}:a.jgrid.getXmlData(b,h.userdata,!0).each(function(){c.p.userData[this.getAttribute("name")]=a(this).text()});b=a.jgrid.getXmlData(b,h.root,!0);(b=a.jgrid.getXmlData(b,h.row,!0))||(b=[]);var R=b.length,C=0,L=[],T=parseInt(c.p.rowNum,10),Z=c.p.scroll?a.jgrid.randId():1;0<R&&0>=c.p.page&&(c.p.page=1);if(b&&R){g&&(T*=g+1);g=a.isFunction(c.p.afterInsertRow);var W=!1,U;c.p.grouping&&(W=!0===c.p.groupingView.groupCollapse,U=a.jgrid.getMethod("groupingPrepare"));
for(;C<R;){N=b[C];E=m(N,Z+C);E=c.p.idPrefix+E;n=0===e?0:e+1;ea=1===(n+C)%2?S:"";var O=G.length;G.push("");M&&G.push(u(0,C,c.p.page,c.p.rowNum));I&&G.push(t(E,M,C,!1));A&&G.push(y.call(p,I+M,C+e));if(h.repeatitems){K||(K=z(I+A+M));var V=a.jgrid.getXmlData(N,h.cell,!0);a.each(K,function(a){var b=V[this];if(!b)return!1;B=b.textContent||b.text;D[c.p.colModel[a+I+A+M].name]=B;G.push(v(E,B,a+I+A+M,C+e,N,D))})}else for(n=0;n<F.length;n++)B=a.jgrid.getXmlData(N,F[n]),D[c.p.colModel[n+I+A+M].name]=B,G.push(v(E,
B,n+I+A+M,C+e,N,D));G[O]=H(E,W,ea,D,N,!1);G.push("</tr>");c.p.grouping&&(L.push(G),c.p.groupingView._locgr||U.call(p,D,C),G=[]);if(l||!0===c.p.treeGrid)D._id_=a.jgrid.stripPref(c.p.idPrefix,E),c.p.data.push(D),c.p._index[D._id_]=c.p.data.length-1;!1===c.p.gridview&&(a("tbody:first",d).append(G.join("")),p.triggerHandler("jqGridAfterInsertRow",[E,D,N]),g&&c.p.afterInsertRow.call(c,E,D,N),G=[]);D={};s++;C++;if(s===T)break}}!0===c.p.gridview&&(q=-1<c.p.treeANode?c.p.treeANode:0,c.p.grouping?l||(p.jqGrid("groupingRender",
L,c.p.colModel.length,c.p.page,T),L=null):!0===c.p.treeGrid&&0<q?a(c.rows[q]).after(G.join("")):a("tbody:first",d).append(G.join("")));if(!0===c.p.subGrid)try{p.jqGrid("addSubGrid",I+M)}catch(ba){}c.p.totaltime=new Date-k;0<s&&0===c.p.records&&(c.p.records=R);G=null;if(!0===c.p.treeGrid)try{p.jqGrid("setTreeNode",q+1,s+q+1)}catch(Q){}c.p.treeGrid||c.p.scroll||(c.grid.bDiv.scrollTop=0);c.p.reccount=s;c.p.treeANode=-1;c.p.userDataOnFooter&&p.jqGrid("footerData","set",c.p.userData,!0);l&&(c.p.records=
R,c.p.lastpage=Math.ceil(R/T));f||c.updatepager(!1,!0);if(l){for(;s<R;){N=b[s];E=m(N,s+Z);E=c.p.idPrefix+E;if(h.repeatitems){K||(K=z(I+A+M));var aa=a.jgrid.getXmlData(N,h.cell,!0);a.each(K,function(a){var b=aa[this];if(!b)return!1;B=b.textContent||b.text;D[c.p.colModel[a+I+A+M].name]=B})}else for(n=0;n<F.length;n++)B=a.jgrid.getXmlData(N,F[n]),D[c.p.colModel[n+I+A+M].name]=B;D._id_=a.jgrid.stripPref(c.p.idPrefix,E);c.p.grouping&&U.call(p,D,s);c.p.data.push(D);c.p._index[D._id_]=c.p.data.length-1;
D={};s++}c.p.grouping&&(c.p.groupingView._locgr=!0,p.jqGrid("groupingRender",L,c.p.colModel.length,c.p.page,T),L=null)}}},J=function(b,d,e,f,g){var k=new Date;if(b){-1!==c.p.treeANode||c.p.scroll?e=1<e?e:1:(w.call(c,!1,!0),e=1);var h,l="local"!==c.p.datatype&&c.p.loadonce||"jsonstring"===c.p.datatype;l&&(c.p.data=[],c.p._index={},c.p.localReader.id="_id_");c.p.reccount=0;"local"===c.p.datatype?(d=c.p.localReader,h="local"):(d=c.p.jsonReader,h="json");var m=a(c),p=0,n,q,s,B=[],I=c.p.multiselect?1:
0,A=!0===c.p.subGrid?1:0,y,M=!0===c.p.rownumbers?1:0,J=z(I+A+M);h=x(h);var D,F,G,K={},N,E,C=[],ea=!0===c.p.altRows?c.p.altclass:"",R;c.p.page=r(a.jgrid.getAccessor(b,d.page),c.p.page);c.p.lastpage=r(a.jgrid.getAccessor(b,d.total),1);c.p.records=r(a.jgrid.getAccessor(b,d.records));c.p.userData=a.jgrid.getAccessor(b,d.userdata)||{};A&&(y=a.jgrid.getMethod("addSubGridCell"));G=!1===c.p.keyName?a.isFunction(d.id)?d.id.call(c,b):d.id:c.p.keyName;F=a.jgrid.getAccessor(b,d.root);null==F&&a.isArray(b)&&(F=
b);F||(F=[]);b=F.length;q=0;0<b&&0>=c.p.page&&(c.p.page=1);var S=parseInt(c.p.rowNum,10),L=c.p.scroll?a.jgrid.randId():1,T=!1,U;g&&(S*=g+1);"local"!==c.p.datatype||c.p.deselectAfterSort||(T=!0);var Z=a.isFunction(c.p.afterInsertRow),W=[],O=!1,V;c.p.grouping&&(O=!0===c.p.groupingView.groupCollapse,V=a.jgrid.getMethod("groupingPrepare"));for(;q<b;){g=F[q];E=a.jgrid.getAccessor(g,G);void 0===E&&("number"===typeof G&&null!=c.p.colModel[G+I+A+M]&&(E=a.jgrid.getAccessor(g,c.p.colModel[G+I+A+M].name)),void 0===
E&&(E=L+q,0===B.length&&d.cell&&(n=a.jgrid.getAccessor(g,d.cell)||g,E=null!=n&&void 0!==n[G]?n[G]:E)));E=c.p.idPrefix+E;n=1===e?0:e;R=1===(n+q)%2?ea:"";T&&(U=c.p.multiselect?-1!==a.inArray(E,c.p.selarrrow):E===c.p.selrow);var ba=C.length;C.push("");M&&C.push(u(0,q,c.p.page,c.p.rowNum));I&&C.push(t(E,M,q,U));A&&C.push(y.call(m,I+M,q+e));D=h;d.repeatitems&&(d.cell&&(g=a.jgrid.getAccessor(g,d.cell)||g),a.isArray(g)&&(D=J));for(s=0;s<D.length;s++)n=a.jgrid.getAccessor(g,D[s]),K[c.p.colModel[s+I+A+M].name]=
n,C.push(v(E,n,s+I+A+M,q+e,g,K));C[ba]=H(E,O,R,K,g,U);C.push("</tr>");c.p.grouping&&(W.push(C),c.p.groupingView._locgr||V.call(m,K,q),C=[]);if(l||!0===c.p.treeGrid)K._id_=a.jgrid.stripPref(c.p.idPrefix,E),c.p.data.push(K),c.p._index[K._id_]=c.p.data.length-1;!1===c.p.gridview&&(a("#"+a.jgrid.jqID(c.p.id)+" tbody:first").append(C.join("")),m.triggerHandler("jqGridAfterInsertRow",[E,K,g]),Z&&c.p.afterInsertRow.call(c,E,K,g),C=[]);K={};p++;q++;if(p===S)break}!0===c.p.gridview&&(N=-1<c.p.treeANode?c.p.treeANode:
0,c.p.grouping?l||(m.jqGrid("groupingRender",W,c.p.colModel.length,c.p.page,S),W=null):!0===c.p.treeGrid&&0<N?a(c.rows[N]).after(C.join("")):a("#"+a.jgrid.jqID(c.p.id)+" tbody:first").append(C.join("")));if(!0===c.p.subGrid)try{m.jqGrid("addSubGrid",I+M)}catch(aa){}c.p.totaltime=new Date-k;0<p&&0===c.p.records&&(c.p.records=b);if(!0===c.p.treeGrid)try{m.jqGrid("setTreeNode",N+1,p+N+1)}catch(Q){}c.p.treeGrid||c.p.scroll||(c.grid.bDiv.scrollTop=0);c.p.reccount=p;c.p.treeANode=-1;c.p.userDataOnFooter&&
m.jqGrid("footerData","set",c.p.userData,!0);l&&(c.p.records=b,c.p.lastpage=Math.ceil(b/S));f||c.updatepager(!1,!0);if(l){for(;p<b&&F[p];){g=F[p];E=a.jgrid.getAccessor(g,G);void 0===E&&("number"===typeof G&&null!=c.p.colModel[G+I+A+M]&&(E=a.jgrid.getAccessor(g,c.p.colModel[G+I+A+M].name)),void 0===E&&(E=L+p,0===B.length&&d.cell&&(e=a.jgrid.getAccessor(g,d.cell)||g,E=null!=e&&void 0!==e[G]?e[G]:E)));if(g){E=c.p.idPrefix+E;D=h;d.repeatitems&&(d.cell&&(g=a.jgrid.getAccessor(g,d.cell)||g),a.isArray(g)&&
(D=J));for(s=0;s<D.length;s++)K[c.p.colModel[s+I+A+M].name]=a.jgrid.getAccessor(g,D[s]);K._id_=a.jgrid.stripPref(c.p.idPrefix,E);c.p.grouping&&V.call(m,K,p);c.p.data.push(K);c.p._index[K._id_]=c.p.data.length-1;K={}}p++}c.p.grouping&&(c.p.groupingView._locgr=!0,m.jqGrid("groupingRender",W,c.p.colModel.length,c.p.page,S))}}},D=function(){function b(a){var c=0,d,e,f,k,h;if(null!=a.groups){(e=a.groups.length&&"OR"===a.groupOp.toString().toUpperCase())&&v.orBegin();for(d=0;d<a.groups.length;d++){0<c&&
e&&v.or();try{b(a.groups[d])}catch(l){alert(l)}c++}e&&v.orEnd()}if(null!=a.rules)try{(f=a.rules.length&&"OR"===a.groupOp.toString().toUpperCase())&&v.orBegin();for(d=0;d<a.rules.length;d++)h=a.rules[d],k=a.groupOp.toString().toUpperCase(),s[h.op]&&h.field&&(0<c&&k&&"OR"===k&&(v=v.or()),v=s[h.op](v,k)(h.field,h.data,g[h.field])),c++;f&&v.orEnd()}catch(m){alert(m)}}var d=c.p.multiSort?[]:"",e=[],f=!1,g={},k=[],h=[],l,m,p;if(a.isArray(c.p.data)){var n=c.p.grouping?c.p.groupingView:!1,r,q;a.each(c.p.colModel,
function(){m=this.sorttype||"text";"date"===m||"datetime"===m?(this.formatter&&"string"===typeof this.formatter&&"date"===this.formatter?(l=this.formatoptions&&this.formatoptions.srcformat?this.formatoptions.srcformat:a.jgrid.formatter.date.srcformat,p=this.formatoptions&&this.formatoptions.newformat?this.formatoptions.newformat:a.jgrid.formatter.date.newformat):l=p=this.datefmt||"Y-m-d",g[this.name]={stype:m,srcfmt:l,newfmt:p,sfunc:this.sortfunc||null}):g[this.name]={stype:m,srcfmt:"",newfmt:"",
...
a.andNot().equals},"in":function(a){return a.equals},nu:function(a){return a.isNull},nn:function(a,c){return"OR"===c?a.orNot().isNull:a.andNot().isNull}},v=a.jgrid.from(c.p.data);c.p.ignoreCase&&(v=v.ignoreCase());if(!0===c.p.search){var t=c.p.postData.filters;if(t)"string"===typeof t&&(t=a.jgrid.parse(t)),b(t);else try{v=s[c.p.postData.searchOper](v)(c.p.postData.searchField,c.p.postData.searchString,g[c.p.postData.searchField])}catch(u){}}if(c.p.grouping)for(q=0;q<r;q++)v.orderBy(h[q],n.groupOrder[q],
k[q].stype,k[q].srcfmt);c.p.multiSort?a.each(d,function(a){v.orderBy(this,e[a],g[this].stype,g[this].srcfmt,g[this].sfunc)}):d&&c.p.sortorder&&f&&("DESC"===c.p.sortorder.toUpperCase()?v.orderBy(c.p.sortname,"d",g[d].stype,g[d].srcfmt,g[d].sfunc):v.orderBy(c.p.sortname,"a",g[d].stype,g[d].srcfmt,g[d].sfunc));var t=v.select(),x=parseInt(c.p.rowNum,10),B=t.length,w=parseInt(c.p.page,10),I=Math.ceil(B/x),z={};if((c.p.search||c.p.resetsearch)&&c.p.grouping&&c.p.groupingView._locgr){c.p.groupingView.groups=
[];var A,M=a.jgrid.getMethod("groupingPrepare"),y,H;if(c.p.footerrow&&c.p.userDataOnFooter){for(y in c.p.userData)c.p.userData.hasOwnProperty(y)&&(c.p.userData[y]=0);H=!0}for(A=0;A<B;A++){if(H)for(y in c.p.userData)c.p.userData[y]+=parseFloat(t[A][y]||0);M.call(a(c),t[A],A,x)}}t=t.slice((w-1)*x,w*x);g=v=null;z[c.p.localReader.total]=I;z[c.p.localReader.page]=w;z[c.p.localReader.records]=B;z[c.p.localReader.root]=t;z[c.p.localReader.userdata]=c.p.userData;t=null;return z}}},y=function(){c.grid.hDiv.loading=
!0;if(!c.p.hiddengrid)switch(c.p.loadui){case "enable":a("#load_"+a.jgrid.jqID(c.p.id)).show();break;case "block":a("#lui_"+a.jgrid.jqID(c.p.id)).show(),a("#load_"+a.jgrid.jqID(c.p.id)).show()}},F=function(){c.grid.hDiv.loading=!1;switch(c.p.loadui){case "enable":a("#load_"+a.jgrid.jqID(c.p.id)).hide();break;case "block":a("#lui_"+a.jgrid.jqID(c.p.id)).hide(),a("#load_"+a.jgrid.jqID(c.p.id)).hide()}},C=function(b){if(!c.grid.hDiv.loading){var d=c.p.scroll&&!1===b,e={},f,g=c.p.prmNames;0>=c.p.page&&
(c.p.page=Math.min(1,c.p.lastpage));null!==g.search&&(e[g.search]=c.p.search);null!==g.nd&&(e[g.nd]=(new Date).getTime());null!==g.rows&&(e[g.rows]=c.p.rowNum);null!==g.page&&(e[g.page]=c.p.page);null!==g.sort&&(e[g.sort]=c.p.sortname);null!==g.order&&(e[g.order]=c.p.sortorder);null!==c.p.rowTotal&&null!==g.totalrows&&(e[g.totalrows]=c.p.rowTotal);var k=a.isFunction(c.p.loadComplete),h=k?c.p.loadComplete:null,l=0;b=b||1;1<b?null!==g.npage?(e[g.npage]=b,l=b-1,b=1):h=function(a){c.p.page++;c.grid.hDiv.loading=
!1;k&&c.p.loadComplete.call(c,a);C(b-1)}:null!==g.npage&&delete c.p.postData[g.npage];if(c.p.grouping){a(c).jqGrid("groupingSetup");var m=c.p.groupingView,p,n="";for(p=0;p<m.groupField.length;p++){var r=m.groupField[p];a.each(c.p.colModel,function(a,c){c.name===r&&c.index&&(r=c.index)});n+=r+" "+m.groupOrder[p]+", "}e[g.sort]=n+e[g.sort]}a.extend(c.p.postData,e);var q=c.p.scroll?c.rows.length-1:1,e=a(c).triggerHandler("jqGridBeforeRequest");if(!1!==e&&"stop"!==e)if(a.isFunction(c.p.datatype))c.p.datatype.call(c,
...
B(e,c.grid.bDiv,q,1<b,l):J(e,c.grid.bDiv,q,1<b,l);a(c).triggerHandler("jqGridLoadComplete",[e]);h&&h.call(c,e);a(c).triggerHandler("jqGridAfterLoadComplete",[e]);d&&c.grid.populateVisible();if(c.p.loadonce||c.p.treeGrid)c.p.datatype="local";1===b&&F()}},error:function(d,e,f){a.isFunction(c.p.loadError)&&c.p.loadError.call(c,d,e,f);1===b&&F()},beforeSend:function(b,d){var e=!0;a.isFunction(c.p.loadBeforeSend)&&(e=c.p.loadBeforeSend.call(c,b,d));void 0===e&&(e=!0);if(!1===e)return!1;y()}},a.jgrid.ajaxOptions,
c.p.ajaxGridOptions));break;case "xmlstring":y();e="string"!==typeof c.p.datastr?c.p.datastr:a.parseXML(c.p.datastr);B(e,c.grid.bDiv);a(c).triggerHandler("jqGridLoadComplete",[e]);k&&c.p.loadComplete.call(c,e);a(c).triggerHandler("jqGridAfterLoadComplete",[e]);c.p.datatype="local";c.p.datastr=null;F();break;case "jsonstring":y();e="string"===typeof c.p.datastr?a.jgrid.parse(c.p.datastr):c.p.datastr;J(e,c.grid.bDiv);a(c).triggerHandler("jqGridLoadComplete",[e]);k&&c.p.loadComplete.call(c,e);a(c).triggerHandler("jqGridAfterLoadComplete",
[e]);c.p.datatype="local";c.p.datastr=null;F();break;case "local":case "clientside":y(),c.p.datatype="local",e=D(),J(e,c.grid.bDiv,q,1<b,l),a(c).triggerHandler("jqGridLoadComplete",[e]),h&&h.call(c,e),a(c).triggerHandler("jqGridAfterLoadComplete",[e]),d&&c.grid.populateVisible(),F()}}}},O=function(b){a("#cb_"+a.jgrid.jqID(c.p.id),c.grid.hDiv)[c.p.useProp?"prop":"attr"]("checked",b);if(c.p.frozenColumns&&c.p.id+"_frozen")a("#cb_"+a.jgrid.jqID(c.p.id),c.grid.fhDiv)[c.p.useProp?"prop":"attr"]("checked",
b)},Q=function(b,d){var e="",f="<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>",g="",h,l,m,p,n=function(b){var d;a.isFunction(c.p.onPaging)&&(d=c.p.onPaging.call(c,b));if("stop"===d)return!1;c.p.selrow=null;c.p.multiselect&&(c.p.selarrrow=[],O(!1));c.p.savedRow=[];return!0};b=b.substr(1);d+="_"+b;h="pg_"+b;l=b+"_left";m=b+"_center";p=b+"_right";a("#"+a.jgrid.jqID(b)).append("<div id='"+h+"' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='"+
l+"' align='left'></td><td id='"+m+"' align='center' style='white-space:pre;'></td><td id='"+p+"' align='right'></td></tr></tbody></table></div>").attr("dir","ltr");if(0<c.p.rowList.length){g="<td dir='"+k+"'>";g+="<select class='ui-pg-selbox' role='listbox'>";for(l=0;l<c.p.rowList.length;l++)g+='<option role="option" value="'+c.p.rowList[l]+'"'+(c.p.rowNum===c.p.rowList[l]?' selected="selected"':"")+">"+c.p.rowList[l]+"</option>";g+="</select></td>"}"rtl"===k&&(f+=g);!0===c.p.pginput&&(e="<td dir='"+
...
c.p._nvtd=[];c.p._nvtd[0]=f?Math.floor((c.p.width-f)/2):Math.floor(c.p.width/3);c.p._nvtd[1]=0;f=null;a(".ui-pg-selbox","#"+h).bind("change",function(){if(!n("records"))return!1;c.p.page=Math.round(c.p.rowNum*(c.p.page-1)/this.value-0.5)+1;c.p.rowNum=this.value;c.p.pager&&a(".ui-pg-selbox",c.p.pager).val(this.value);c.p.toppager&&a(".ui-pg-selbox",c.p.toppager).val(this.value);C();return!1});!0===c.p.pgbuttons&&(a(".ui-pg-button","#"+h).hover(function(){a(this).hasClass("ui-state-disabled")?this.style.cursor=
...
0===b&&(l=h=!1,b=e-1);if(!n(this.id))return!1;this.id==="first"+d&&g&&(c.p.page=1,f=!0);this.id==="prev"+d&&k&&(c.p.page=b-1,f=!0);this.id==="next"+d&&h&&(c.p.page=b+1,f=!0);this.id==="last"+d&&l&&(c.p.page=e,f=!0);f&&C();return!1}));!0===c.p.pginput&&a("input.ui-pg-input","#"+h).keypress(function(b){if(13===(b.charCode||b.keyCode||0)){if(!n("user"))return!1;a(this).val(r(a(this).val(),1));c.p.page=0<a(this).val()?a(this).val():c.p.page;C();return!1}return this})},Y=function(b,d){var e,f="",g=c.p.colModel,
...
a("span.s-ico",h).hide();c.p.sortorder="";a.each(g,function(a){this.lso&&(0<a&&k&&(f+=", "),e=this.lso.split("-"),f+=g[a].index||g[a].name,f+=" "+e[e.length-1],k=!0,c.p.sortorder=e[e.length-1])});h=f.lastIndexOf(c.p.sortorder);f=f.substring(0,h);c.p.sortname=f},E=function(b,d,e,f,g){if(c.p.colModel[d].sortable&&!(0<c.p.savedRow.length)){e||(c.p.lastsort===d?"asc"===c.p.sortorder?c.p.sortorder="desc":"desc"===c.p.sortorder&&(c.p.sortorder="asc"):c.p.sortorder=c.p.colModel[d].firstsortorder||"asc",
...
c.p.scroll&&(c.p.pgbuttons=!1,c.p.pginput=!1,c.p.rowList=[]);c.p.data.length&&A();var I="<thead><tr class='ui-jqgrid-labels' role='rowheader'>",M,K,N,Z,R,G,L,S,ia=S="",T=[],ja=[];K=[];if(!0===c.p.shrinkToFit&&!0===c.p.forceFit)for(g=c.p.colModel.length-1;0<=g;g--)if(!c.p.colModel[g].hidden){c.p.colModel[g].resizable=!1;break}"horizontal"===c.p.viewsortcols[1]&&(S=" ui-i-asc",ia=" ui-i-desc");M=m?"class='ui-th-div-ie'":"";S="<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc"+
S+" ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-"+k+"'></span>"+("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc"+ia+" ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-"+k+"'></span></span>");if(c.p.multiSort)for(T=c.p.sortname.split(","),g=0;g<T.length;g++)K=a.trim(T[g]).split(" "),T[g]=a.trim(K[0]),ja[g]=K[1]?a.trim(K[1]):c.p.sortorder||"asc";for(g=0;g<this.p.colNames.length;g++)K=c.p.headertitles?' title="'+a.jgrid.stripHtml(c.p.colNames[g])+'"':"",I+="<th id='"+c.p.id+
"_"+c.p.colModel[g].name+"' role='columnheader' class='ui-state-default ui-th-column ui-th-"+k+"'"+K+">",K=c.p.colModel[g].index||c.p.colModel[g].name,I+="<div id='jqgh_"+c.p.id+"_"+c.p.colModel[g].name+"' "+M+">"+c.p.colNames[g],c.p.colModel[g].width=c.p.colModel[g].width?parseInt(c.p.colModel[g].width,10):150,"boolean"!==typeof c.p.colModel[g].title&&(c.p.colModel[g].title=!0),c.p.colModel[g].lso="",K===c.p.sortname&&(c.p.lastsort=g),c.p.multiSort&&(K=a.inArray(K,T),-1!==K&&(c.p.colModel[g].lso=
ja[K])),I+=S+"</div></th>";I+="</tr></thead>";S=null;a(this).append(I);a("thead tr:first th",this).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});if(this.p.multiselect){var W=[],ca;a("#cb_"+a.jgrid.jqID(c.p.id),this).bind("click",function(){c.p.selarrrow=[];var b=!0===c.p.frozenColumns?c.p.id+"_frozen":"";this.checked?(a(c.rows).each(function(d){0<d&&!a(this).hasClass("ui-subgrid")&&!a(this).hasClass("jqgroup")&&!a(this).hasClass("ui-state-disabled")&&
...
c.p.onSelectAll.call(c,ca?c.p.selarrrow:W,ca)})}!0===c.p.autowidth&&(I=a(p).innerWidth(),c.p.width=0<I?I:"nw");(function(){var b=0,d=a.jgrid.cell_width?0:r(c.p.cellLayout,0),f=0,g,k=r(c.p.scrollOffset,0),l,m=!1,p,n=0,q;a.each(c.p.colModel,function(){void 0===this.hidden&&(this.hidden=!1);if(c.p.grouping&&c.p.autowidth){var e=a.inArray(this.name,c.p.groupingView.groupField);0<=e&&c.p.groupingView.groupColumnShow.length>e&&(this.hidden=!c.p.groupingView.groupColumnShow[e])}this.widthOrg=l=r(this.width,
0);!1===this.hidden&&(b+=l+d,this.fixed?n+=l+d:f++)});isNaN(c.p.width)&&(c.p.width=b+(!1!==c.p.shrinkToFit||isNaN(c.p.height)?0:k));e.width=c.p.width;c.p.tblwidth=b;!1===c.p.shrinkToFit&&!0===c.p.forceFit&&(c.p.forceFit=!1);!0===c.p.shrinkToFit&&0<f&&(p=e.width-d*f-n,isNaN(c.p.height)||(p-=k,m=!0),b=0,a.each(c.p.colModel,function(a){!1!==this.hidden||this.fixed||(this.width=l=Math.round(p*this.width/(c.p.tblwidth-d*f-n)),b+=l,g=a)}),q=0,m?e.width-n-(b+d*f)!==k&&(q=e.width-n-(b+d*f)-k):m||1===Math.abs(e.width-
n-(b+d*f))||(q=e.width-n-(b+d*f)),c.p.colModel[g].width+=q,c.p.tblwidth=b+q+d*f+n,c.p.tblwidth>c.p.width&&(c.p.colModel[g].width-=c.p.tblwidth-parseInt(c.p.width,10),c.p.tblwidth=c.p.width))})();a(p).css("width",e.width+"px").append("<div class='ui-jqgrid-resize-mark' id='rs_m"+c.p.id+"'>&#160;</div>");a(l).css("width",e.width+"px");var I=a("thead:first",c).get(0),V="";c.p.footerrow&&(V+="<table role='grid' style='width:"+c.p.tblwidth+"px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-"+
k+"'>");var l=a("tr:first",I),da="<tr class='jqgfirstrow' role='row' style='height:auto'>";c.p.disableClick=!1;a("th",l).each(function(b){N=c.p.colModel[b].width;void 0===c.p.colModel[b].resizable&&(c.p.colModel[b].resizable=!0);c.p.colModel[b].resizable?(Z=document.createElement("span"),a(Z).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+k).css("cursor","col-resize"),a(this).addClass(c.p.resizeclass)):Z="";a(this).css("width",N+"px").prepend(Z);Z=null;var d="";c.p.colModel[b].hidden&&
(a(this).css("display","none"),d="display:none;");da+="<td role='gridcell' style='height:0px;width:"+N+"px;"+d+"'></td>";e.headers[b]={width:N,el:this};R=c.p.colModel[b].sortable;"boolean"!==typeof R&&(R=c.p.colModel[b].sortable=!0);d=c.p.colModel[b].name;"cb"!==d&&"subgrid"!==d&&"rn"!==d&&c.p.viewsortcols[2]&&a(">div",this).addClass("ui-jqgrid-sortable");R&&(c.p.multiSort?c.p.viewsortcols[0]?(a("div span.s-ico",this).show(),c.p.colModel[b].lso&&a("div span.ui-icon-"+c.p.colModel[b].lso,this).removeClass("ui-state-disabled")):
...
"px"}).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom").appendTo(p),X&&a(c.p.pager).hide(),Q(c.p.pager,""));!1===c.p.cellEdit&&!0===c.p.hoverrows&&a(c).bind("mouseover",function(c){L=a(c.target).closest("tr.jqgrow");"ui-subgrid"!==a(L).attr("class")&&a(L).addClass("ui-state-hover")}).bind("mouseout",function(c){L=a(c.target).closest("tr.jqgrow");a(L).removeClass("ui-state-hover")});var P,$,ga;a(c).before(e.hDiv).click(function(b){G=b.target;L=a(G,c.rows).closest("tr.jqgrow");if(0===a(L).length||
-1<L[0].className.indexOf("ui-state-disabled")||(a(G,c).closest("table.ui-jqgrid-btable").attr("id")||"").replace("_frozen","")!==c.id)return this;var d=a(G).hasClass("cbox"),e=a(c).triggerHandler("jqGridBeforeSelectRow",[L[0].id,b]);(e=!1===e||"stop"===e?!1:!0)&&a.isFunction(c.p.beforeSelectRow)&&(e=c.p.beforeSelectRow.call(c,L[0].id,b));if("A"!==G.tagName&&("INPUT"!==G.tagName&&"TEXTAREA"!==G.tagName&&"OPTION"!==G.tagName&&"SELECT"!==G.tagName||d)&&!0===e)if(P=L[0].id,$=a.jgrid.getCellIndex(G),
ga=a(G).closest("td,th").html(),a(c).triggerHandler("jqGridCellSelect",[P,$,ga,b]),a.isFunction(c.p.onCellSelect)&&c.p.onCellSelect.call(c,P,$,ga,b),!0===c.p.cellEdit)if(c.p.multiselect&&d)a(c).jqGrid("setSelection",P,!0,b);else{P=L[0].rowIndex;try{a(c).jqGrid("editCell",P,$,!0)}catch(f){}}else if(c.p.multikey)b[c.p.multikey]?a(c).jqGrid("setSelection",P,!0,b):c.p.multiselect&&d&&(d=a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+P).is(":checked"),a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+P)[c.p.useProp?"prop":"attr"]("checked",
...
c.p.selarrrow=[]}a(c).jqGrid("setSelection",P,!0,b)}}).bind("reloadGrid",function(b,d){!0===c.p.treeGrid&&(c.p.datatype=c.p.treedatatype);d&&d.current&&c.grid.selectionPreserver(c);"local"===c.p.datatype?(a(c).jqGrid("resetSelection"),c.p.data.length&&A()):c.p.treeGrid||(c.p.selrow=null,c.p.multiselect&&(c.p.selarrrow=[],O(!1)),c.p.savedRow=[]);c.p.scroll&&w.call(c,!0,!1);if(d&&d.page){var e=d.page;e>c.p.lastpage&&(e=c.p.lastpage);1>e&&(e=1);c.p.page=e;c.grid.bDiv.scrollTop=c.grid.prevRowHeight?(e-
1)*c.grid.prevRowHeight*c.p.rowNum:0}c.grid.prevRowHeight&&c.p.scroll?(delete c.p.lastpage,c.grid.populateVisible()):c.grid.populate();!0===c.p._inlinenav&&a(c).jqGrid("showAddEditButtons");return!1}).dblclick(function(b){G=b.target;L=a(G,c.rows).closest("tr.jqgrow");0!==a(L).length&&(P=L[0].rowIndex,$=a.jgrid.getCellIndex(G),a(c).triggerHandler("jqGridDblClickRow",[a(L).attr("id"),P,$,b]),a.isFunction(c.p.ondblClickRow)&&c.p.ondblClickRow.call(c,a(L).attr("id"),P,$,b))}).bind("contextmenu",function(b){G=
b.target;L=a(G,c.rows).closest("tr.jqgrow");0!==a(L).length&&(c.p.multiselect||a(c).jqGrid("setSelection",L[0].id,!0,b),P=L[0].rowIndex,$=a.jgrid.getCellIndex(G),a(c).triggerHandler("jqGridRightClickRow",[a(L).attr("id"),P,$,b]),a.isFunction(c.p.onRightClickRow)&&c.p.onRightClickRow.call(c,a(L).attr("id"),P,$,b))});e.bDiv=document.createElement("div");m&&"auto"===String(c.p.height).toLowerCase()&&(c.p.height="100%");a(e.bDiv).append(a('<div style="position:relative;'+(m&&8>a.jgrid.msiever()?"height:0.01%;":
...
a.isFunction(c.p.gridComplete)&&c.p.gridComplete.call(c);a(c).triggerHandler("jqGridAfterGridComplete")};c.refreshIndex=A;c.setHeadCheckBox=O;c.constructTr=H;c.formatter=function(a,b,c,d,e){return s(a,b,c,d,e)};a.extend(e,{populate:C,emptyRows:w,beginReq:y,endReq:F});this.grid=e;c.addXmlData=function(a){B(a,c.grid.bDiv)};c.addJSONData=function(a){J(a,c.grid.bDiv)};this.grid.cols=this.rows[0].cells;a(c).triggerHandler("jqGridInitGrid");a.isFunction(c.p.onInitGrid)&&c.p.onInitGrid.call(c);C();c.p.hiddengrid=
...
return c},addRowData:function(d,e,b,f){b||(b="last");var c=!1,h,g,k,l,m,p,r,q,n="",s,v,t,u,x,z;e&&(a.isArray(e)?(s=!0,b="last",v=d):(e=[e],s=!1),this.each(function(){var w=e.length;m=!0===this.p.rownumbers?1:0;k=!0===this.p.multiselect?1:0;l=!0===this.p.subGrid?1:0;s||(void 0!==d?d=String(d):(d=a.jgrid.randId(),!1!==this.p.keyName&&(v=this.p.keyName,void 0!==e[0][v]&&(d=e[0][v]))));t=this.p.altclass;for(var A=0,H="",B={},J=a.isFunction(this.p.afterInsertRow)?!0:!1;A<w;){u=e[A];g=[];if(s){try{d=u[v],
void 0===d&&(d=a.jgrid.randId())}catch(D){d=a.jgrid.randId()}H=!0===this.p.altRows?0===(this.rows.length-1)%2?t:"":""}z=d;d=this.p.idPrefix+d;m&&(n=this.formatCol(0,1,"",null,d,!0),g[g.length]='<td role="gridcell" class="ui-state-default jqgrid-rownum" '+n+">0</td>");k&&(q='<input role="checkbox" type="checkbox" id="jqg_'+this.p.id+"_"+d+'" class="cbox"/>',n=this.formatCol(m,1,"",null,d,!0),g[g.length]='<td role="gridcell" '+n+">"+q+"</td>");l&&(g[g.length]=a(this).jqGrid("addSubGridCell",k+m,1));
for(r=k+l+m;r<this.p.colModel.length;r++)x=this.p.colModel[r],h=x.name,B[h]=u[h],q=this.formatter(d,a.jgrid.getAccessor(u,h),r,u),n=this.formatCol(r,1,q,u,d,B),g[g.length]='<td role="gridcell" '+n+">"+q+"</td>";g.unshift(this.constructTr(d,!1,H,B,u,!1));g[g.length]="</tr>";if(0===this.rows.length)a("table:first",this.grid.bDiv).append(g.join(""));else switch(b){case "last":a(this.rows[this.rows.length-1]).after(g.join(""));p=this.rows.length-1;break;case "first":a(this.rows[0]).after(g.join(""));
p=1;break;case "after":if(p=a(this).jqGrid("getGridRowById",f))a(this.rows[p.rowIndex+1]).hasClass("ui-subgrid")?a(this.rows[p.rowIndex+1]).after(g):a(p).after(g.join("")),p=p.rowIndex+1;break;case "before":if(p=a(this).jqGrid("getGridRowById",f))a(p).before(g.join("")),p=p.rowIndex-1}!0===this.p.subGrid&&a(this).jqGrid("addSubGrid",k+m,p);this.p.records++;this.p.reccount++;a(this).triggerHandler("jqGridAfterInsertRow",[d,u,u]);J&&this.p.afterInsertRow.call(this,d,u,u);A++;"local"===this.p.datatype&&
(B[this.p.localReader.id]=z,this.p._index[z]=this.p.data.length,this.p.data.push(B),B={})}!0!==this.p.altRows||s||("last"===b?1===(this.rows.length-1)%2&&a(this.rows[this.rows.length-1]).addClass(t):a(this.rows).each(function(b){1===b%2?a(this).addClass(t):a(this).removeClass(t)}));this.updatepager(!0,!0);c=!0}));return c},footerData:function(d,e,b){function f(a){for(var b in a)if(a.hasOwnProperty(b))return!1;return!0}var c,h=!1,g={},k;void 0==d&&(d="get");"boolean"!==typeof b&&(b=!0);d=d.toLowerCase();
...
var q=0<c?!0:!1;if(!0===d.stringResult||"local"===e.p.datatype){var n='{"groupOp":"'+d.groupOp+'","rules":[',s=0;a.each(b,function(a,b){0<s&&(n+=",");n+='{"field":"'+a+'",';n+='"op":"'+p[a]+'",';n+='"data":"'+(b+"").replace(/\\/g,"\\\\").replace(/\"/g,'\\"')+'"}';s++});n+="]}";a.extend(e.p.postData,{filters:n});a.each(["searchField","searchString","searchOper"],function(a,b){e.p.postData.hasOwnProperty(b)&&delete e.p.postData[b]})}else a.extend(e.p.postData,b);var v;e.p.searchurl&&(v=e.p.url,a(e).jqGrid("setGridParam",
{url:e.p.searchurl}));var t="stop"===a(e).triggerHandler("jqGridToolbarBeforeSearch")?!0:!1;!t&&a.isFunction(d.beforeSearch)&&(t=d.beforeSearch.call(e));t||a(e).jqGrid("setGridParam",{search:q}).trigger("reloadGrid",[{page:1}]);v&&a(e).jqGrid("setGridParam",{url:v});a(e).triggerHandler("jqGridToolbarAfterSearch");a.isFunction(d.afterSearch)&&d.afterSearch.call(e)},f=function(c,f,h){a("#sopt_menu").remove();f=parseInt(f,10);h=parseInt(h,10)+18;f='<ul id="sopt_menu" class="ui-search-menu" role="menu" tabindex="0" style="font-size:'+
...
!0===d.autosearch&&a("select",n).change(function(){b();return!1});c=null}},a.jgrid.ajaxOptions,e.p.ajaxSelectOptions||{}));else{var v,t,u;k.searchoptions?(v=void 0===k.searchoptions.value?"":k.searchoptions.value,t=void 0===k.searchoptions.separator?":":k.searchoptions.separator,u=void 0===k.searchoptions.delimiter?";":k.searchoptions.delimiter):k.editoptions&&(v=void 0===k.editoptions.value?"":k.editoptions.value,t=void 0===k.editoptions.separator?":":k.editoptions.separator,u=void 0===k.editoptions.delimiter?
";":k.editoptions.delimiter);if(v){var x=document.createElement("select");x.style.width="100%";a(x).attr({name:k.index||k.name,id:"gs_"+k.name});var z;if("string"===typeof v)for(m=v.split(u),z=0;z<m.length;z++)v=m[z].split(t),u=document.createElement("option"),u.value=v[0],u.innerHTML=v[1],x.appendChild(u);else if("object"===typeof v)for(z in v)v.hasOwnProperty(z)&&(u=document.createElement("option"),u.value=z,u.innerHTML=v[z],x.appendChild(u));void 0!==l.defaultValue&&a(x).val(l.defaultValue);l.attr&&
a(x).attr(l.attr);a(n).append(s);a.jgrid.bindEv.call(e,x,l);a("td:eq(1)",s).append(x);!0===d.autosearch&&a(x).change(function(){b();return!1})}}break;case "text":t=void 0!==l.defaultValue?l.defaultValue:"";a("td:eq(1)",s).append("<input type='text' style='width:100%;padding:0px;' name='"+(k.index||k.name)+"' id='gs_"+k.name+"' value='"+t+"'/>");a(n).append(s);l.attr&&a("input",n).attr(l.attr);a.jgrid.bindEv.call(e,a("input",n)[0],l);!0===d.autosearch&&(d.searchOnEnter?a("input",n).keypress(function(a){return 13===
...
d;var e,b,f=0,c,h,g,k,l,m=this.p.colModel,p=m.length,r=this.grid.headers,q=a("table.ui-jqgrid-htable",this.grid.hDiv),n=q.children("thead").children("tr.ui-jqgrid-labels:last").addClass("jqg-second-row-header");c=q.children("thead");var s=q.find(".jqg-first-row-header");void 0===s[0]?s=a("<tr>",{role:"row","aria-hidden":"true"}).addClass("jqg-first-row-header").css("height","auto"):s.empty();var v,t=function(a,b){var c=b.length,d;for(d=0;d<c;d++)if(b[d].startColumnName===a)return d;return-1};a(this).prepend(c);
c=a("<tr>",{role:"rowheader"}).addClass("ui-jqgrid-labels jqg-third-row-header");for(e=0;e<p;e++)if(g=r[e].el,k=a(g),b=m[e],h={height:"0px",width:r[e].width+"px",display:b.hidden?"none":""},a("<th>",{role:"gridcell"}).css(h).addClass("ui-first-th-"+this.p.direction).appendTo(s),g.style.width="",h=t(b.name,d.groupHeaders),0<=h){h=d.groupHeaders[h];f=h.numberOfColumns;l=h.titleText;for(h=b=0;h<f&&e+h<p;h++)m[e+h].hidden||b++;h=a("<th>").attr({role:"columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-"+
...
0;e<b.groups.length;e++)k=a("<tr></tr>"),g.append(k),h=a("<td class='first'></td>"),k.append(h),h=a("<td colspan='4'></td>"),h.append(this.createTableForGroup(b.groups[e],b)),k.append(h);void 0===b.groupOp&&(b.groupOp=d.p.groupOps[0].op);if(void 0!==b.rules)for(e=0;e<b.rules.length;e++)g.append(this.createTableRowForRule(b.rules[e],b));return g};this.createTableRowForRule=function(b,c){var d=this,e=a("#"+a.jgrid.jqID(f.id))[0]||null,g=a("<tr></tr>"),h,l,t,u,x="",z;g.append("<td class='first'></td>");
var w=a("<td class='columns'></td>");g.append(w);var A=a("<select></select>"),H,B=[];w.append(A);A.bind("change",function(){b.field=a(A).val();t=a(this).parents("tr:first");for(h=0;h<d.p.columns.length;h++)if(d.p.columns[h].name===b.field){u=d.p.columns[h];break}if(u){u.searchoptions.id=a.jgrid.randId();k&&"text"===u.inputtype&&!u.searchoptions.size&&(u.searchoptions.size=10);var c=a.jgrid.createEl.call(e,u.inputtype,u.searchoptions,"",!0,d.p.ajaxSelectOptions||{},!0);a(c).addClass("input-elm");l=
u.searchoptions.sopt?u.searchoptions.sopt:d.p.sopt?d.p.sopt:-1!==a.inArray(u.searchtype,d.p.strarr)?d.p.stropts:d.p.numopts;var f="",g=0;B=[];a.each(d.p.ops,function(){B.push(this.oper)});for(h=0;h<l.length;h++)H=a.inArray(l[h],B),-1!==H&&(0===g&&(b.op=d.p.ops[H].oper),f+="<option value='"+d.p.ops[H].oper+"'>"+d.p.ops[H].text+"</option>",g++);a(".selectopts",t).empty().append(f);a(".selectopts",t)[0].selectedIndex=0;a.jgrid.msie&&9>a.jgrid.msiever()&&(f=parseInt(a("select.selectopts",t)[0].offsetWidth,
10)+1,a(".selectopts",t).width(f),a(".selectopts",t).css("width","auto"));a(".data",t).empty().append(c);a.jgrid.bindEv.call(e,c,u.searchoptions);a(".input-elm",t).bind("change",function(c){c=c.target;b.data="SPAN"===c.nodeName.toUpperCase()&&u.searchoptions&&a.isFunction(u.searchoptions.custom_value)?u.searchoptions.custom_value.call(e,a(c).children(".customelement:first"),"get"):c.value;d.onchange()});setTimeout(function(){b.data=a(c).val();d.onchange()},0)}});for(h=w=0;h<d.p.columns.length;h++){z=
void 0===d.p.columns[h].search?!0:d.p.columns[h].search;var J=!0===d.p.columns[h].hidden;if(!0===d.p.columns[h].searchoptions.searchhidden&&z||z&&!J)z="",b.field===d.p.columns[h].name&&(z=" selected='selected'",w=h),x+="<option value='"+d.p.columns[h].name+"'"+z+">"+d.p.columns[h].label+"</option>"}A.append(x);x=a("<td class='operators'></td>");g.append(x);u=f.columns[w];u.searchoptions.id=a.jgrid.randId();k&&"text"===u.inputtype&&!u.searchoptions.size&&(u.searchoptions.size=10);w=a.jgrid.createEl.call(e,
u.inputtype,u.searchoptions,b.data,!0,d.p.ajaxSelectOptions||{},!0);if("nu"===b.op||"nn"===b.op)a(w).attr("readonly","true"),a(w).attr("disabled","true");var D=a("<select class='selectopts'></select>");x.append(D);D.bind("change",function(){b.op=a(D).val();t=a(this).parents("tr:first");var c=a(".input-elm",t)[0];"nu"===b.op||"nn"===b.op?(b.data="","SELECT"!==c.tagName.toUpperCase()&&(c.value=""),c.setAttribute("readonly","true"),c.setAttribute("disabled","true")):("SELECT"===c.tagName.toUpperCase()&&
(b.data=c.value),c.removeAttribute("readonly"),c.removeAttribute("disabled"));d.onchange()});l=u.searchoptions.sopt?u.searchoptions.sopt:d.p.sopt?d.p.sopt:-1!==a.inArray(u.searchtype,d.p.strarr)?d.p.stropts:d.p.numopts;x="";a.each(d.p.ops,function(){B.push(this.oper)});for(h=0;h<l.length;h++)H=a.inArray(l[h],B),-1!==H&&(z=b.op===d.p.ops[H].oper?" selected='selected'":"",x+="<option value='"+d.p.ops[H].oper+"'"+z+">"+d.p.ops[H].text+"</option>");D.append(x);x=a("<td class='data'></td>");g.append(x);
x.append(w);a.jgrid.bindEv.call(e,w,u.searchoptions);a(w).addClass("input-elm").bind("change",function(){b.data="custom"===u.inputtype?u.searchoptions.custom_value.call(e,a(this).children(".customelement:first"),"get"):a(this).val();d.onchange()});x=a("<td></td>");g.append(x);!0===this.p.ruleButtons&&(w=a("<input type='button' value='-' title='Delete rule' class='delete-rule ui-del'/>"),x.append(w),w.bind("click",function(){for(h=0;h<c.rules.length;h++)if(c.rules[h]===b){c.rules.splice(h,1);break}d.reDraw();
...
d.Find+"</a>",s="<a id='"+c+"_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>"+d.Reset+"</a>",v="",t="",u,x=!1,z=-1;d.showQuery&&(v="<a id='"+c+"_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>");d.columns.length?(q=d.columns,z=0,u=q[0].index||q[0].name):a.each(q,function(a,b){b.label||(b.label=f.p.colNames[a]);if(!x){var c=
void 0===b.search?!0:b.search,d=!0===b.hidden;if(b.searchoptions&&!0===b.searchoptions.searchhidden&&c||c&&!d)x=!0,u=b.index||b.name,z=a}});if(!l&&u||!1===d.multipleSearch){var w="eq";0<=z&&q[z].searchoptions&&q[z].searchoptions.sopt?w=q[z].searchoptions.sopt[0]:d.sopt&&d.sopt.length&&(w=d.sopt[0]);l={groupOp:"AND",rules:[{field:u,op:w,data:""}]}}x=!1;d.tmplNames&&d.tmplNames.length&&(x=!0,t=d.tmplLabel,t+="<select class='ui-template'>",t+="<option value='default'>Default</option>",a.each(d.tmplNames,
function(a,b){t+="<option value='"+a+"'>"+b+"</option>"}),t+="</select>");p="<table class='EditTable' style='border:0px none;margin-top:5px' id='"+c+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:"+p+"'>"+s+t+"</td><td class='EditButton' "+r+">"+v+n+"</td></tr></tbody></table>";c=a.jgrid.jqID(c);a("#"+c).jqFilter({columns:q,filter:d.loadDefaults?l:null,showQuery:d.showQuery,errorcheck:d.errorcheck,sopt:d.sopt,
groupButton:d.multipleGroup,ruleButtons:d.multipleSearch,afterRedraw:d.afterRedraw,ops:d.odata,operands:d.operands,ajaxSelectOptions:f.p.ajaxSelectOptions,groupOps:d.groupOps,onChange:function(){this.p.showQuery&&a(".query",this).html(this.toUserFriendlyString());a.isFunction(d.afterChange)&&d.afterChange.call(f,a("#"+c),d)},direction:f.p.direction,id:f.p.id});m.append(p);x&&d.tmplFilters&&d.tmplFilters.length&&a(".ui-template",m).bind("change",function(){var b=a(this).val();"default"===b?a("#"+c).jqFilter("addFilter",
...
jqm:d.jqModal,onClose:d.onClose});return!1});a("#"+c+"_reset").bind("click",function(){var b={},h=a("#"+c);f.p.search=!1;f.p.resetsearch=!0;!1===d.multipleSearch?b[d.sField]=b[d.sValue]=b[d.sOper]="":b[d.sFilter]="";h[0].resetFilter();x&&a(".ui-template",m).val("default");a.extend(f.p.postData,b);g=a(f).triggerHandler("jqGridFilterReset");void 0===g&&(g=!0);g&&a.isFunction(d.onReset)&&(g=d.onReset.call(f));!1!==g&&a(f).trigger("reloadGrid",[{page:1}]);d.closeAfterReset&&a.jgrid.hideModal("#"+a.jgrid.jqID(k.themodal),
...
break;case "password":case "text":case "textarea":case "button":y[this.name]=a(this).val()}n.p.autoencode&&(y[this.name]=a.jgrid.htmlEncode(y[this.name]))}});return!0}function c(b,c,e,f){var g,k,h,l=0,m,p,q,r=[],s=!1,t="",u;for(u=1;u<=f;u++)t+="<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";"_empty"!==b&&(s=a(c).jqGrid("getInd",b));a(c.p.colModel).each(function(u){g=this.name;p=(k=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";
if("cb"!==g&&"subgrid"!==g&&!0===this.editable&&"rn"!==g){if(!1===s)m="";else if(g===c.p.ExpandColumn&&!0===c.p.treeGrid)m=a("td[role='gridcell']:eq("+u+")",c.rows[s]).text();else{try{m=a.unformat.call(c,a("td[role='gridcell']:eq("+u+")",c.rows[s]),{rowId:b,colModel:this},u)}catch(x){m=this.edittype&&"textarea"===this.edittype?a("td[role='gridcell']:eq("+u+")",c.rows[s]).text():a("td[role='gridcell']:eq("+u+")",c.rows[s]).html()}if(!m||"&nbsp;"===m||"&#160;"===m||1===m.length&&160===m.charCodeAt(0))m=
""}var B=a.extend({},this.editoptions||{},{id:g,name:g}),w=a.extend({},{elmprefix:"",elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),z=parseInt(w.rowpos,10)||l+1,A=parseInt(2*(parseInt(w.colpos,10)||1),10);"_empty"===b&&B.defaultValue&&(m=a.isFunction(B.defaultValue)?B.defaultValue.call(n):B.defaultValue);this.edittype||(this.edittype="text");n.p.autoencode&&(m=a.jgrid.htmlDecode(m));q=a.jgrid.createEl.call(n,this.edittype,B,m,!1,a.extend({},a.jgrid.ajaxOptions,c.p.ajaxSelectOptions||
{}));if(d[n.p.id].checkOnSubmit||d[n.p.id].checkOnUpdate)d[n.p.id]._savedData[g]=m;a(q).addClass("FormElement");-1<a.inArray(this.edittype,["text","textarea","password","select"])&&a(q).addClass("ui-widget-content ui-corner-all");h=a(e).find("tr[rowpos="+z+"]");if(w.rowabove){var y=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+w.rowcontent+"</td></tr>");a(e).append(y);y[0].rp=z}0===h.length&&(h=a("<tr "+p+" rowpos='"+z+"'></tr>").addClass("FormData").attr("id","tr_"+g),a(h).append(t),a(e).append(h),
h[0].rp=z);a("td:eq("+(A-2)+")",h[0]).html(void 0===w.label?c.p.colNames[u]:w.label);a("td:eq("+(A-1)+")",h[0]).append(w.elmprefix).append(q).append(w.elmsuffix);"custom"===this.edittype&&a.isFunction(B.custom_value)&&B.custom_value.call(n,a("#"+g,"#"+v),"set",m);a.jgrid.bindEv.call(n,q,B);r[l]=u;l++}});0<l&&(u=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+c.p.id+"_id' value='"+
...
e[1]=d[n.p.id].errorTextFormat.call(n,f,C):e[1]=g+" Status: '"+f.statusText+"'. Error code: "+f.status):(e=a(n).triggerHandler("jqGridAddEditAfterSubmit",[f,y,C]),void 0===e&&(e=[!0,"",""]),e[0]&&a.isFunction(d[n.p.id].afterSubmit)&&(e=d[n.p.id].afterSubmit.call(n,f,y,C)));if(!1===e[0])a("#FormError>td",u).html(e[1]),a("#FormError",u).show();else if(n.p.autoencode&&a.each(y,function(b,c){y[b]=a.jgrid.htmlDecode(c)}),y[m]===k.addoper?(e[2]||(e[2]=a.jgrid.randId()),y[l]=e[2],d[n.p.id].reloadAfterSubmit?
...
!1),"_empty"!==d[n.p.id]._savedData[n.p.id+"_id"])for(p in d[n.p.id]._savedData)d[n.p.id]._savedData.hasOwnProperty(p)&&y[p]&&(d[n.p.id]._savedData[p]=y[p]);d[n.p.id].processing=!1;a("#sData",u+"_2").removeClass("ui-state-active");try{a(":input:visible","#"+v)[0].focus()}catch(r){}}},a.jgrid.ajaxOptions,d[n.p.id].ajaxEditOptions);r.url||d[n.p.id].useDataProxy||(a.isFunction(n.p.dataProxy)?d[n.p.id].useDataProxy=!0:(e[0]=!1,e[1]+=" "+a.jgrid.errors.nourl));e[0]&&(d[n.p.id].useDataProxy?(f=n.p.dataProxy.call(n,
r,"set_"+n.p.id),void 0===f&&(f=[!0,""]),!1===f[0]?(e[0]=!1,e[1]=f[1]||"Error deleting the selected row!"):(r.data.oper===k.addoper&&d[n.p.id].closeAfterAdd&&a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(s),jqm:b.jqModal,onClose:d[n.p.id].onClose}),r.data.oper===k.editoper&&d[n.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(s),jqm:b.jqModal,onClose:d[n.p.id].onClose}))):a.ajax(r))}!1===e[0]&&(a("#FormError>td",u).html(e[1]),
a("#FormError",u).show())}function l(a,b){var c=!1,d;for(d in a)if(a.hasOwnProperty(d)&&a[d]!=b[d]){c=!0;break}return c}function m(){var b=!0;a("#FormError",u).hide();d[n.p.id].checkOnUpdate&&(y={},f(),F=l(y,d[n.p.id]._savedData))&&(a("#"+v).data("disabled",!0),a(".confirm","#"+x.themodal).show(),b=!1);return b}function p(){var b;if("_empty"!==e&&void 0!==n.p.savedRow&&0<n.p.savedRow.length&&a.isFunction(a.fn.jqGrid.restoreRow))for(b=0;b<n.p.savedRow.length;b++)if(n.p.savedRow[b].id==e){a(n).jqGrid("restoreRow",
...
function q(){var b=a(n).jqGrid("getDataIDs"),c=a("#id_g",u).val();return[a.inArray(c,b),b]}var n=this;if(n.grid&&e){var s=n.p.id,v="FrmGrid_"+s,t="TblGrid_"+s,u="#"+a.jgrid.jqID(t),x={themodal:"editmod"+s,modalhead:"edithd"+s,modalcontent:"editcnt"+s,scrollelm:v},z=a.isFunction(d[n.p.id].beforeShowForm)?d[n.p.id].beforeShowForm:!1,w=a.isFunction(d[n.p.id].afterShowForm)?d[n.p.id].afterShowForm:!1,A=a.isFunction(d[n.p.id].beforeInitData)?d[n.p.id].beforeInitData:!1,H=a.isFunction(d[n.p.id].onInitializeForm)?
d[n.p.id].onInitializeForm:!1,B=!0,J=1,D=0,y,F,C,v=a.jgrid.jqID(v);"new"===e?(e="_empty",C="add",b.caption=d[n.p.id].addCaption):(b.caption=d[n.p.id].editCaption,C="edit");b.recreateForm||a(n).data("formProp")&&a.extend(d[a(this)[0].p.id],a(n).data("formProp"));var O=!0;b.checkOnUpdate&&b.jqModal&&!b.modal&&(O=!1);var Q=isNaN(d[a(this)[0].p.id].dataheight)?d[a(this)[0].p.id].dataheight:d[a(this)[0].p.id].dataheight+"px",B=isNaN(d[a(this)[0].p.id].datawidth)?d[a(this)[0].p.id].datawidth:d[a(this)[0].p.id].datawidth+
"px",Q=a("<form name='FormPost' id='"+v+"' class='FormGrid' onSubmit='return false;' style='width:"+B+";overflow:auto;position:relative;height:"+Q+";'></form>").data("disabled",!1),Y=a("<table id='"+t+"' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>");a(n.p.colModel).each(function(){var a=this.formoptions;J=Math.max(J,a?a.colpos||0:0);D=Math.max(D,a?a.rowpos||0:0)});a(Q).append(Y);B=a("<tr id='FormError' style='display:none'><td class='ui-state-error' colspan='"+
2*J+"'></td></tr>");B[0].rp=0;a(Y).append(B);B=a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+2*J+"'>"+d[n.p.id].topinfo+"</td></tr>");B[0].rp=0;a(Y).append(B);B=a(n).triggerHandler("jqGridAddEditBeforeInitData",[Q,C]);void 0===B&&(B=!0);B&&A&&(B=A.call(n,Q,C));if(!1!==B){p();var B=(A="rtl"===n.p.direction?!0:!1)?"nData":"pData",E=A?"pData":"nData";c(e,n,Y,J);var B="<a id='"+B+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",
E="<a id='"+E+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>",aa="<a id='sData' class='fm-button ui-state-default ui-corner-all'>"+b.bSubmit+"</a>",U="<a id='cData' class='fm-button ui-state-default ui-corner-all'>"+b.bCancel+"</a>",t="<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='"+t+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>"+
(A?E+B:B+E)+"</td><td class='EditButton'>"+aa+U+"</td></tr>"+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+d[n.p.id].bottominfo+"</td></tr>"),t=t+"</tbody></table>";if(0<D){var ba=[];a.each(a(Y)[0].rows,function(a,b){ba[a]=b});ba.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(ba,function(b,c){a("tbody",Y).append(c)})}b.gbox="#gbox_"+a.jgrid.jqID(s);var fa=!1;!0===b.closeOnEscape&&(b.closeOnEscape=!1,fa=!0);t=a("<div></div>").append(Q).append(t);a.jgrid.createModal(x,
t,d[a(this)[0].p.id],"#gview_"+a.jgrid.jqID(n.p.id),a("#gbox_"+a.jgrid.jqID(n.p.id))[0]);A&&(a("#pData, #nData",u+"_2").css("float","right"),a(".EditButton",u+"_2").css("text-align","left"));d[n.p.id].topinfo&&a(".tinfo",u).show();d[n.p.id].bottominfo&&a(".binfo",u+"_2").show();t=t=null;a("#"+a.jgrid.jqID(x.themodal)).keydown(function(c){var e=c.target;if(!0===a("#"+v).data("disabled"))return!1;if(!0===d[n.p.id].savekey[0]&&c.which===d[n.p.id].savekey[1]&&"TEXTAREA"!==e.tagName)return a("#sData",
u+"_2").trigger("click"),!1;if(27===c.which){if(!m())return!1;fa&&a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:b.gbox,jqm:b.jqModal,onClose:d[n.p.id].onClose});return!1}if(!0===d[n.p.id].navkeys[0]){if("_empty"===a("#id_g",u).val())return!0;if(c.which===d[n.p.id].navkeys[1])return a("#pData",u+"_2").trigger("click"),!1;if(c.which===d[n.p.id].navkeys[2])return a("#nData",u+"_2").trigger("click"),!1}});b.checkOnUpdate&&(a("a.ui-jqdialog-titlebar-close span","#"+a.jgrid.jqID(x.themodal)).removeClass("jqmClose"),
...
b.saveicon[2]+"'></span>");!0===b.closeicon[0]&&a("#cData",u+"_2").addClass("right"===b.closeicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+b.closeicon[2]+"'></span>");if(d[n.p.id].checkOnSubmit||d[n.p.id].checkOnUpdate)aa="<a id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+b.bYes+"</a>",E="<a id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+b.bNo+"</a>",U="<a id='cNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+
b.bExit+"</a>",t=b.zIndex||999,t++,a("<div class='"+b.overlayClass+" jqgrid-overlay confirm' style='z-index:"+t+";display:none;'>&#160;</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:"+(t+1)+"'>"+b.saveData+"<br/><br/>"+aa+E+U+"</div>").insertAfter("#"+v),a("#sNew","#"+a.jgrid.jqID(x.themodal)).click(function(){k();a("#"+v).data("disabled",!1);a(".confirm","#"+a.jgrid.jqID(x.themodal)).hide();return!1}),a("#nNew","#"+a.jgrid.jqID(x.themodal)).click(function(){a(".confirm",
"#"+a.jgrid.jqID(x.themodal)).hide();a("#"+v).data("disabled",!1);setTimeout(function(){a(":input:visible","#"+v)[0].focus()},0);return!1}),a("#cNew","#"+a.jgrid.jqID(x.themodal)).click(function(){a(".confirm","#"+a.jgrid.jqID(x.themodal)).hide();a("#"+v).data("disabled",!1);a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(s),jqm:b.jqModal,onClose:d[n.p.id].onClose});return!1});a(n).triggerHandler("jqGridAddEditInitializeForm",[a("#"+v),C]);H&&H.call(n,a("#"+v),C);"_empty"!==
e&&d[n.p.id].viewPagerButtons?a("#pData,#nData",u+"_2").show():a("#pData,#nData",u+"_2").hide();a(n).triggerHandler("jqGridAddEditBeforeShowForm",[a("#"+v),C]);z&&z.call(n,a("#"+v),C);a("#"+a.jgrid.jqID(x.themodal)).data("onClose",d[n.p.id].onClose);a.jgrid.viewModal("#"+a.jgrid.jqID(x.themodal),{gbox:"#gbox_"+a.jgrid.jqID(s),jqm:b.jqModal,overlay:b.overlay,modal:b.modal,overlayClass:b.overlayClass,onHide:function(b){var c=a("#editmod"+s)[0].style.height;-1<c.indexOf("px")&&(c=parseFloat(c));a(n).data("formProp",
{top:parseFloat(a(b.w).css("top")),left:parseFloat(a(b.w).css("left")),width:a(b.w).width(),height:c,dataheight:a("#"+v).height(),datawidth:a("#"+v).width()});b.w.remove();b.o&&b.o.remove()}});O||a("."+a.jgrid.jqID(b.overlayClass)).click(function(){if(!m())return!1;a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(s),jqm:b.jqModal,onClose:d[n.p.id].onClose});return!1});a(".fm-button","#"+a.jgrid.jqID(x.themodal)).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});
a("#sData",u+"_2").click(function(){y={};a("#FormError",u).hide();f();"_empty"===y[n.p.id+"_id"]?k():!0===b.checkOnSubmit?(F=l(y,d[n.p.id]._savedData))?(a("#"+v).data("disabled",!0),a(".confirm","#"+a.jgrid.jqID(x.themodal)).show()):k():k();return!1});a("#cData",u+"_2").click(function(){if(!m())return!1;a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(s),jqm:b.jqModal,onClose:d[n.p.id].onClose});return!1});a("#nData",u+"_2").click(function(){if(!m())return!1;a("#FormError",
u).hide();var c=q();c[0]=parseInt(c[0],10);if(-1!==c[0]&&c[1][c[0]+1]){a(n).triggerHandler("jqGridAddEditClickPgButtons",["next",a("#"+v),c[1][c[0]]]);var d;if(a.isFunction(b.onclickPgButtons)&&(d=b.onclickPgButtons.call(n,"next",a("#"+v),c[1][c[0]]),void 0!==d&&!1===d)||a("#"+a.jgrid.jqID(c[1][c[0]+1])).hasClass("ui-state-disabled"))return!1;h(c[1][c[0]+1],n,v);a(n).jqGrid("setSelection",c[1][c[0]+1]);a(n).triggerHandler("jqGridAddEditAfterClickPgButtons",["next",a("#"+v),c[1][c[0]]]);a.isFunction(b.afterclickPgButtons)&&
b.afterclickPgButtons.call(n,"next",a("#"+v),c[1][c[0]+1]);r(c[0]+1,c)}return!1});a("#pData",u+"_2").click(function(){if(!m())return!1;a("#FormError",u).hide();var c=q();if(-1!==c[0]&&c[1][c[0]-1]){a(n).triggerHandler("jqGridAddEditClickPgButtons",["prev",a("#"+v),c[1][c[0]]]);var d;if(a.isFunction(b.onclickPgButtons)&&(d=b.onclickPgButtons.call(n,"prev",a("#"+v),c[1][c[0]]),void 0!==d&&!1===d)||a("#"+a.jgrid.jqID(c[1][c[0]-1])).hasClass("ui-state-disabled"))return!1;h(c[1][c[0]-1],n,v);a(n).jqGrid("setSelection",
...
b.labelswidth+"'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>",t="",u=["integer","number","currency"],v=0,w=0,x,z,A;for(r=1;r<=f;r++)t+=1===r?s:"<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";a(d.p.colModel).each(function(){(k=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)||"right"!==this.align||(this.formatter&&-1!==a.inArray(this.formatter,
u)?v=Math.max(v,parseInt(this.width,10)):w=Math.max(w,parseInt(this.width,10)))});x=0!==v?v:0!==w?w:0;q=a(d).jqGrid("getInd",c);a(d.p.colModel).each(function(b){g=this.name;z=!1;n=(k=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";A="boolean"!==typeof this.viewable?!0:this.viewable;if("cb"!==g&&"subgrid"!==g&&"rn"!==g&&A){m=!1===q?"":g===d.p.ExpandColumn&&!0===d.p.treeGrid?a("td:eq("+b+")",d.rows[q]).text():a("td:eq("+b+")",d.rows[q]).html();z="right"===
this.align&&0!==x?!0:!1;var c=a.extend({},{rowabove:!1,rowcontent:""},this.formoptions||{}),r=parseInt(c.rowpos,10)||l+1,s=parseInt(2*(parseInt(c.colpos,10)||1),10);if(c.rowabove){var u=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+c.rowcontent+"</td></tr>");a(e).append(u);u[0].rp=r}h=a(e).find("tr[rowpos="+r+"]");0===h.length&&(h=a("<tr "+n+" rowpos='"+r+"'></tr>").addClass("FormData").attr("id","trv_"+g),a(h).append(t),a(e).append(h),h[0].rp=r);a("td:eq("+(s-2)+")",h[0]).html("<b>"+(void 0===
c.label?d.p.colNames[b]:c.label)+"</b>");a("td:eq("+(s-1)+")",h[0]).append("<span>"+m+"</span>").attr("id","v_"+g);z&&a("td:eq("+(s-1)+") span",h[0]).css({"text-align":"right",width:x+"px"});p[l]=b;l++}});0<l&&(c=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='"+c+"'/></td></tr>"),c[0].rp=l+99,a(e).append(c));return p}function h(b,c){var d,e,f=0,g,k;if(k=a(c).jqGrid("getInd",
...
return[a.inArray(c,b),b]}var l=this;if(l.grid&&e){var m=l.p.id,p="ViewGrid_"+a.jgrid.jqID(m),r="ViewTbl_"+a.jgrid.jqID(m),q="ViewGrid_"+m,n="ViewTbl_"+m,s={themodal:"viewmod"+m,modalhead:"viewhd"+m,modalcontent:"viewcnt"+m,scrollelm:p},v=a.isFunction(d[l.p.id].beforeInitData)?d[l.p.id].beforeInitData:!1,t=!0,u=1,x=0;b.recreateForm||a(l).data("viewProp")&&a.extend(d[a(this)[0].p.id],a(l).data("viewProp"));var z=isNaN(d[a(this)[0].p.id].dataheight)?d[a(this)[0].p.id].dataheight:d[a(this)[0].p.id].dataheight+
...
v&&(t=v.call(l,q),void 0===t&&(t=!0));if(!1!==t){c(e,l,A,u);n="rtl"===l.p.direction?!0:!1;v="<a id='"+(n?"nData":"pData")+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>";t="<a id='"+(n?"pData":"nData")+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>";z="<a id='cData' class='fm-button ui-state-default ui-corner-all'>"+b.bClose+"</a>";if(0<x){var H=[];a.each(a(A)[0].rows,function(a,
b){H[a]=b});H.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(H,function(b,c){a("tbody",A).append(c)})}b.gbox="#gbox_"+a.jgrid.jqID(m);q=a("<div></div>").append(q).append("<table border='0' class='EditTable' id='"+r+"_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='"+b.labelswidth+"'>"+(n?t+v:v+t)+"</td><td class='EditButton'>"+z+"</td></tr></tbody></table>");a.jgrid.createModal(s,q,b,"#gview_"+a.jgrid.jqID(l.p.id),a("#gview_"+a.jgrid.jqID(l.p.id))[0]);n&&(a("#pData, #nData",
...
{themodal:"delmod"+k,modalhead:"delhd"+k,modalcontent:"delcnt"+k,scrollelm:p};a.isArray(e)&&(e=e.join());if(void 0!==a("#"+a.jgrid.jqID(t.themodal))[0]){g&&(m=g.call(f,a("#"+p)),void 0===m&&(m=!0));if(!1===m)return;a("#DelData>td","#"+p).text(e);a("#DelError","#"+p).hide();!0===d[f.p.id].processing&&(d[f.p.id].processing=!1,a("#dData","#"+p).removeClass("ui-state-active"));c&&d[f.p.id].beforeShowForm.call(f,a("#"+p));a.jgrid.viewModal("#"+a.jgrid.jqID(t.themodal),{gbox:"#gbox_"+a.jgrid.jqID(k),jqm:d[f.p.id].jqModal,
jqM:!1,overlay:d[f.p.id].overlay,modal:d[f.p.id].modal})}else{var u=isNaN(d[f.p.id].dataheight)?d[f.p.id].dataheight:d[f.p.id].dataheight+"px",x=isNaN(b.datawidth)?b.datawidth:b.datawidth+"px",v="<div id='"+v+"' class='formdata' style='width:"+x+";overflow:auto;position:relative;height:"+u+";'><table class='DelTable'><tbody>",v=v+"<tr id='DelError' style='display:none'><td class='ui-state-error'></td></tr>",v=v+("<tr id='DelData' style='display:none'><td >"+e+"</td></tr>"),v=v+('<tr><td class="delmsg" style="white-space:pre;">'+
...
a.jgrid.jqID(k);a.jgrid.createModal(t,v,b,"#gview_"+a.jgrid.jqID(f.p.id),a("#gview_"+a.jgrid.jqID(f.p.id))[0]);g&&(m=g.call(f,a(v)),void 0===m&&(m=!0));if(!1===m)return;a(".fm-button","#"+p+"_2").hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});b.delicon=a.extend([!0,"left","ui-icon-scissors"],d[f.p.id].delicon);b.cancelicon=a.extend([!0,"left","ui-icon-cancel"],d[f.p.id].cancelicon);!0===b.delicon[0]&&a("#dData","#"+p+"_2").addClass("right"===
...
f.p.idPrefix+g[0])}catch(m){}else for(l=0;l<g.length;l++)a(f).jqGrid("delRowData",f.p.idPrefix+g[l]);f.p.selrow=null;f.p.selarrrow=[]}a.isFunction(d[f.p.id].afterComplete)&&setTimeout(function(){d[f.p.id].afterComplete.call(f,e,g)},500)}d[f.p.id].processing=!1;a("#dData","#"+p+"_2").removeClass("ui-state-active");c[0]&&a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(k),jqm:b.jqModal,onClose:d[f.p.id].onClose})}},a.jgrid.ajaxOptions,d[f.p.id].ajaxDelOptions);e.url||d[f.p.id].useDataProxy||
(a.isFunction(f.p.dataProxy)?d[f.p.id].useDataProxy=!0:(c[0]=!1,c[1]+=" "+a.jgrid.errors.nourl));c[0]&&(d[f.p.id].useDataProxy?(e=f.p.dataProxy.call(f,e,"del_"+f.p.id),void 0===e&&(e=[!0,""]),!1===e[0]?(c[0]=!1,c[1]=e[1]||"Error deleting the selected row!"):a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(k),jqm:b.jqModal,onClose:d[f.p.id].onClose})):a.ajax(e))}!1===c[0]&&(a("#DelError>td","#"+p).html(c[1]),a("#DelError","#"+p).show());return!1});a("#eData","#"+p+"_2").click(function(){a.jgrid.hideModal("#"+
a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(k),jqm:d[f.p.id].jqModal,onClose:d[f.p.id].onClose});return!1});c&&d[f.p.id].beforeShowForm.call(f,a("#"+p));a.jgrid.viewModal("#"+a.jgrid.jqID(t.themodal),{gbox:"#gbox_"+a.jgrid.jqID(k),jqm:d[f.p.id].jqModal,overlay:d[f.p.id].overlay,modal:d[f.p.id].modal})}h&&d[f.p.id].afterShowForm.call(f,a("#"+p));!0===d[f.p.id].closeOnEscape&&setTimeout(function(){a(".ui-jqdialog-titlebar-close","#"+a.jgrid.jqID(t.modalhead)).attr("tabindex","-1").focus()},0)}})},
navGrid:function(d,b,f,c,h,g,k){b=a.extend({edit:!0,editicon:"ui-icon-pencil",add:!0,addicon:"ui-icon-plus",del:!0,delicon:"ui-icon-trash",search:!0,searchicon:"ui-icon-search",refresh:!0,refreshicon:"ui-icon-refresh",refreshstate:"firstpage",view:!1,viewicon:"ui-icon-document",position:"left",closeOnEscape:!0,beforeRefresh:null,afterRefresh:null,cloneToTop:!1,alertwidth:200,alertheight:"auto",alerttop:null,alertleft:null,alertzIndex:null},a.jgrid.nav,b||{});return this.each(function(){if(!this.nav){var l=
{themodal:"alertmod_"+this.p.id,modalhead:"alerthd_"+this.p.id,modalcontent:"alertcnt_"+this.p.id},m=this,p;if(m.grid&&"string"===typeof d){void 0===a("#"+l.themodal)[0]&&(b.alerttop||b.alertleft||(void 0!==window.innerWidth?(b.alertleft=window.innerWidth,b.alerttop=window.innerHeight):void 0!==document.documentElement&&void 0!==document.documentElement.clientWidth&&0!==document.documentElement.clientWidth?(b.alertleft=document.documentElement.clientWidth,b.alerttop=document.documentElement.clientHeight):
(b.alertleft=1024,b.alerttop=768),b.alertleft=b.alertleft/2-parseInt(b.alertwidth,10)/2,b.alerttop=b.alerttop/2-25),a.jgrid.createModal(l,"<div>"+b.alerttext+"</div><span tabindex='0'><span tabindex='-1' id='jqg_alrt'></span></span>",{gbox:"#gbox_"+a.jgrid.jqID(m.p.id),jqModal:!0,drag:!0,resize:!0,caption:b.alertcap,top:b.alerttop,left:b.alertleft,width:b.alertwidth,height:b.alertheight,closeOnEscape:b.closeOnEscape,zIndex:b.alertzIndex},"#gview_"+a.jgrid.jqID(m.p.id),a("#gbox_"+a.jgrid.jqID(m.p.id))[0],
!0));var r=1,q,n=function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover")},s=function(){a(this).removeClass("ui-state-hover")};b.cloneToTop&&m.p.toppager&&(r=2);for(q=0;q<r;q++){var v=a("<table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"),t,u;0===q?(t=d,u=m.p.id,t===m.p.toppager&&(u+="_top",r=1)):(t=m.p.toppager,u=m.p.id+"_top");"rtl"===m.p.direction&&a(v).attr("dir","rtl").css("float",
"right");b.add&&(c=c||{},p=a("<td class='ui-pg-button ui-corner-all'></td>"),a(p).append("<div class='ui-pg-div'><span class='ui-icon "+b.addicon+"'></span>"+b.addtext+"</div>"),a("tr",v).append(p),a(p,v).attr({title:b.addtitle||"",id:c.id||"add_"+u}).click(function(){a(this).hasClass("ui-state-disabled")||(a.isFunction(b.addfunc)?b.addfunc.call(m):a(m).jqGrid("editGridRow","new",c));return!1}).hover(n,s),p=null);b.edit&&(p=a("<td class='ui-pg-button ui-corner-all'></td>"),f=f||{},a(p).append("<div class='ui-pg-div'><span class='ui-icon "+
b.editicon+"'></span>"+b.edittext+"</div>"),a("tr",v).append(p),a(p,v).attr({title:b.edittitle||"",id:f.id||"edit_"+u}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var c=m.p.selrow;c?a.isFunction(b.editfunc)?b.editfunc.call(m,c):a(m).jqGrid("editGridRow",c,f):(a.jgrid.viewModal("#"+l.themodal,{gbox:"#gbox_"+a.jgrid.jqID(m.p.id),jqm:!0}),a("#jqg_alrt").focus())}return!1}).hover(n,s),p=null);b.view&&(p=a("<td class='ui-pg-button ui-corner-all'></td>"),k=k||{},a(p).append("<div class='ui-pg-div'><span class='ui-icon "+
b.viewicon+"'></span>"+b.viewtext+"</div>"),a("tr",v).append(p),a(p,v).attr({title:b.viewtitle||"",id:k.id||"view_"+u}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var c=m.p.selrow;c?a.isFunction(b.viewfunc)?b.viewfunc.call(m,c):a(m).jqGrid("viewGridRow",c,k):(a.jgrid.viewModal("#"+l.themodal,{gbox:"#gbox_"+a.jgrid.jqID(m.p.id),jqm:!0}),a("#jqg_alrt").focus())}return!1}).hover(n,s),p=null);b.del&&(p=a("<td class='ui-pg-button ui-corner-all'></td>"),h=h||{},a(p).append("<div class='ui-pg-div'><span class='ui-icon "+
b.delicon+"'></span>"+b.deltext+"</div>"),a("tr",v).append(p),a(p,v).attr({title:b.deltitle||"",id:h.id||"del_"+u}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var c;m.p.multiselect?(c=m.p.selarrrow,0===c.length&&(c=null)):c=m.p.selrow;c?a.isFunction(b.delfunc)?b.delfunc.call(m,c):a(m).jqGrid("delGridRow",c,h):(a.jgrid.viewModal("#"+l.themodal,{gbox:"#gbox_"+a.jgrid.jqID(m.p.id),jqm:!0}),a("#jqg_alrt").focus())}return!1}).hover(n,s),p=null);(b.add||b.edit||b.del||b.view)&&a("tr",v).append("<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>");
b.search&&(p=a("<td class='ui-pg-button ui-corner-all'></td>"),g=g||{},a(p).append("<div class='ui-pg-div'><span class='ui-icon "+b.searchicon+"'></span>"+b.searchtext+"</div>"),a("tr",v).append(p),a(p,v).attr({title:b.searchtitle||"",id:g.id||"search_"+u}).click(function(){a(this).hasClass("ui-state-disabled")||(a.isFunction(b.searchfunc)?b.searchfunc.call(m,g):a(m).jqGrid("searchGrid",g));return!1}).hover(n,s),g.showOnLoad&&!0===g.showOnLoad&&a(p,v).click(),p=null);b.refresh&&(p=a("<td class='ui-pg-button ui-corner-all'></td>"),
a(p).append("<div class='ui-pg-div'><span class='ui-icon "+b.refreshicon+"'></span>"+b.refreshtext+"</div>"),a("tr",v).append(p),a(p,v).attr({title:b.refreshtitle||"",id:"refresh_"+u}).click(function(){if(!a(this).hasClass("ui-state-disabled")){a.isFunction(b.beforeRefresh)&&b.beforeRefresh.call(m);m.p.search=!1;m.p.resetsearch=!0;try{if("currentfilter"!==b.refreshstate){var c=m.p.id;m.p.postData.filters="";try{a("#fbox_"+a.jgrid.jqID(c)).jqFilter("resetFilter")}catch(d){}a.isFunction(m.clearToolbar)&&
...
e.length&&160===e.charCodeAt(0))e="";var x=a.jgrid.createEl.call(b,p[f].edittype,s,e,!0,a.extend({},a.jgrid.ajaxOptions,b.p.ajaxSelectOptions||{}));a(x).addClass("editable");l?a("span:first",this).append(x):a(this).append(x);a.jgrid.bindEv.call(b,x,s);"select"===p[f].edittype&&void 0!==p[f].editoptions&&!0===p[f].editoptions.multiple&&void 0===p[f].editoptions.dataUrl&&a.jgrid.msie&&a(x).width(a(x).width());g++}}),0<g&&(h.id=d,b.p.savedRow.push(h),a(l).attr("editable","1"),setTimeout(function(){var b=
a("td:eq("+k+") input",l).not(":disabled");0<b.length&&b.focus()},0),!0===m.keys&&a(l).bind("keydown",function(c){if(27===c.keyCode){a(b).jqGrid("restoreRow",d,m.afterrestorefunc);if(b.p._inlinenav)try{a(b).jqGrid("showAddEditButtons")}catch(e){}return!1}if(13===c.keyCode){if("TEXTAREA"===c.target.tagName)return!0;if(a(b).jqGrid("saveRow",d,m)&&b.p._inlinenav)try{a(b).jqGrid("showAddEditButtons")}catch(f){}return!1}}),a(b).triggerHandler("jqGridInlineEditRow",[d,m]),a.isFunction(m.oneditfunc)&&m.oneditfunc.call(b,
d))))))})},saveRow:function(d,e,b,f,c,h,g){var k=a.makeArray(arguments).slice(1),l={};"object"===a.type(k[0])?l=k[0]:(a.isFunction(e)&&(l.successfunc=e),void 0!==b&&(l.url=b),void 0!==f&&(l.extraparam=f),a.isFunction(c)&&(l.aftersavefunc=c),a.isFunction(h)&&(l.errorfunc=h),a.isFunction(g)&&(l.afterrestorefunc=g));var l=a.extend(!0,{successfunc:null,url:null,extraparam:{},aftersavefunc:null,errorfunc:null,afterrestorefunc:null,restoreAfterError:!0,mtype:"POST"},a.jgrid.inlineEdit,l),m=!1,p=this[0],
r,q={},n={},s={},v,t,u;if(!p.grid)return m;u=a(p).jqGrid("getInd",d,!0);if(!1===u)return m;k=a.isFunction(l.beforeSaveRow)?l.beforeSaveRow.call(p,l,d):void 0;void 0===k&&(k=!0);if(k){k=a(u).attr("editable");l.url=l.url||p.p.editurl;if("1"===k){var x;a('td[role="gridcell"]',u).each(function(b){x=p.p.colModel[b];r=x.name;if("cb"!==r&&"subgrid"!==r&&!0===x.editable&&"rn"!==r&&!a(this).hasClass("not-editable-cell")){switch(x.edittype){case "checkbox":var c=["Yes","No"];x.editoptions&&(c=x.editoptions.value.split(":"));
q[r]=a("input",this).is(":checked")?c[0]:c[1];break;case "text":case "password":case "textarea":case "button":q[r]=a("input, textarea",this).val();break;case "select":if(x.editoptions.multiple){var c=a("select",this),d=[];q[r]=a(c).val();q[r]=q[r]?q[r].join(","):"";a("select option:selected",this).each(function(b,c){d[b]=a(c).text()});n[r]=d.join(",")}else q[r]=a("select option:selected",this).val(),n[r]=a("select option:selected",this).text();x.formatter&&"select"===x.formatter&&(n={});break;case "custom":try{if(x.editoptions&&
a.isFunction(x.editoptions.custom_value)){if(q[r]=x.editoptions.custom_value.call(p,a(".customelement",this),"get"),void 0===q[r])throw"e2";}else throw"e1";}catch(e){"e1"===e&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===e?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,e.message,a.jgrid.edit.bClose)}}t=a.jgrid.checkValues.call(p,
q[r],b);if(!1===t[0])return!1;p.p.autoencode&&(q[r]=a.jgrid.htmlEncode(q[r]));"clientArray"!==l.url&&x.editoptions&&!0===x.editoptions.NullIfEmpty&&""===q[r]&&(s[r]="null")}});if(!1===t[0]){try{var z=a(p).jqGrid("getGridRowById",d),w=a.jgrid.findPos(z);a.jgrid.info_dialog(a.jgrid.errors.errcap,t[1],a.jgrid.edit.bClose,{left:w[0],top:w[1]+a(z).outerHeight()})}catch(A){alert(t[1])}return m}k=p.p.prmNames;z=d;w=!1===p.p.keyName?k.id:p.p.keyName;q&&(q[k.oper]=k.editoper,void 0===q[w]||""===q[w]?q[w]=
d:u.id!==p.p.idPrefix+q[w]&&(k=a.jgrid.stripPref(p.p.idPrefix,d),void 0!==p.p._index[k]&&(p.p._index[q[w]]=p.p._index[k],delete p.p._index[k]),d=p.p.idPrefix+q[w],a(u).attr("id",d),p.p.selrow===z&&(p.p.selrow=d),a.isArray(p.p.selarrrow)&&(k=a.inArray(z,p.p.selarrrow),0<=k&&(p.p.selarrrow[k]=d)),p.p.multiselect&&(k="jqg_"+p.p.id+"_"+d,a("input.cbox",u).attr("id",k).attr("name",k))),void 0===p.p.inlineData&&(p.p.inlineData={}),q=a.extend({},q,p.p.inlineData,l.extraparam));if("clientArray"===l.url){q=
a.extend({},q,n);p.p.autoencode&&a.each(q,function(b,c){q[b]=a.jgrid.htmlDecode(c)});k=a(p).jqGrid("setRowData",d,q);a(u).attr("editable","0");for(w=0;w<p.p.savedRow.length;w++)if(String(p.p.savedRow[w].id)===String(z)){v=w;break}0<=v&&p.p.savedRow.splice(v,1);a(p).triggerHandler("jqGridInlineAfterSaveRow",[d,k,q,l]);a.isFunction(l.aftersavefunc)&&l.aftersavefunc.call(p,d,k,q,l);m=!0;a(u).removeClass("jqgrid-new-row").unbind("keydown")}else a("#lui_"+a.jgrid.jqID(p.p.id)).show(),s=a.extend({},q,s),
s[w]=a.jgrid.stripPref(p.p.idPrefix,s[w]),a.ajax(a.extend({url:l.url,data:a.isFunction(p.p.serializeRowData)?p.p.serializeRowData.call(p,s):s,type:l.mtype,async:!1,complete:function(b,c){a("#lui_"+a.jgrid.jqID(p.p.id)).hide();if("success"===c){var e=!0,f;f=a(p).triggerHandler("jqGridInlineSuccessSaveRow",[b,d,l]);a.isArray(f)||(f=[!0,q]);f[0]&&a.isFunction(l.successfunc)&&(f=l.successfunc.call(p,b));a.isArray(f)?(e=f[0],q=f[1]||q):e=f;if(!0===e){p.p.autoencode&&a.each(q,function(b,c){q[b]=a.jgrid.htmlDecode(c)});
q=a.extend({},q,n);a(p).jqGrid("setRowData",d,q);a(u).attr("editable","0");for(e=0;e<p.p.savedRow.length;e++)if(String(p.p.savedRow[e].id)===String(d)){v=e;break}0<=v&&p.p.savedRow.splice(v,1);a(p).triggerHandler("jqGridInlineAfterSaveRow",[d,b,q,l]);a.isFunction(l.aftersavefunc)&&l.aftersavefunc.call(p,d,b,q,l);m=!0;a(u).removeClass("jqgrid-new-row").unbind("keydown")}else a(p).triggerHandler("jqGridInlineErrorSaveRow",[d,b,c,null,l]),a.isFunction(l.errorfunc)&&l.errorfunc.call(p,d,b,c,null),!0===
l.restoreAfterError&&a(p).jqGrid("restoreRow",d,l.afterrestorefunc)}},error:function(b,c,e){a("#lui_"+a.jgrid.jqID(p.p.id)).hide();a(p).triggerHandler("jqGridInlineErrorSaveRow",[d,b,c,e,l]);if(a.isFunction(l.errorfunc))l.errorfunc.call(p,d,b,c,e);else{b=b.responseText||b.statusText;try{a.jgrid.info_dialog(a.jgrid.errors.errcap,'<div class="ui-state-error">'+b+"</div>",a.jgrid.edit.bClose,{buttonalign:"right"})}catch(f){alert(b)}}!0===l.restoreAfterError&&a(p).jqGrid("restoreRow",d,l.afterrestorefunc)}},
a.jgrid.ajaxOptions,p.p.ajaxRowOptions||{}))}return m}},restoreRow:function(d,e){var b=a.makeArray(arguments).slice(1),f={};"object"===a.type(b[0])?f=b[0]:a.isFunction(e)&&(f.afterrestorefunc=e);f=a.extend(!0,{},a.jgrid.inlineEdit,f);return this.each(function(){var b=this,e=-1,g,k={},l;if(b.grid&&(g=a(b).jqGrid("getInd",d,!0),!1!==g&&(l=a.isFunction(f.beforeCancelRow)?f.beforeCancelRow.call(b,f,sr):void 0,void 0===l&&(l=!0),l))){for(l=0;l<b.p.savedRow.length;l++)if(String(b.p.savedRow[l].id)===String(d)){e=
l;break}if(0<=e){if(a.isFunction(a.fn.datepicker))try{a("input.hasDatepicker","#"+a.jgrid.jqID(g.id)).datepicker("hide")}catch(m){}a.each(b.p.colModel,function(){!0===this.editable&&b.p.savedRow[e].hasOwnProperty(this.name)&&(k[this.name]=b.p.savedRow[e][this.name])});a(b).jqGrid("setRowData",d,k);a(g).attr("editable","0").unbind("keydown");b.p.savedRow.splice(e,1);a("#"+a.jgrid.jqID(d),"#"+a.jgrid.jqID(b.p.id)).hasClass("jqgrid-new-row")&&setTimeout(function(){a(b).jqGrid("delRowData",d);a(b).jqGrid("showAddEditButtons")},
0)}a(b).triggerHandler("jqGridInlineAfterRestoreRow",[d]);a.isFunction(f.afterrestorefunc)&&f.afterrestorefunc.call(b,d)}})},addRow:function(d){d=a.extend(!0,{rowID:null,initdata:{},position:"first",useDefValues:!0,useFormatter:!1,addRowParams:{extraparam:{}}},d||{});return this.each(function(){if(this.grid){var e=this,b=a.isFunction(d.beforeAddRow)?d.beforeAddRow.call(e,d.addRowParams):void 0;void 0===b&&(b=!0);b&&(d.rowID=a.isFunction(d.rowID)?d.rowID.call(e,d):null!=d.rowID?d.rowID:a.jgrid.randId(),
...
if(e.length)for(k in e)e.hasOwnProperty(k)&&(e[k][c]=parseInt(e[k][c],10)-g)}}})},addChildNode:function(d,e,b,f){var c=this[0];if(b){var h=c.p.treeReader.expanded_field,g=c.p.treeReader.leaf_field,k=c.p.treeReader.level_field,l=c.p.treeReader.parent_id_field,m=c.p.treeReader.left_field,p=c.p.treeReader.right_field,r=c.p.treeReader.loaded,q,n,s,v,t;q=0;var u=e,x;void 0===f&&(f=!1);if(void 0===d||null===d){t=c.p.data.length-1;if(0<=t)for(;0<=t;)q=Math.max(q,parseInt(c.p.data[t][c.p.localReader.id],
10)),t--;d=q+1}var z=a(c).jqGrid("getInd",e);x=!1;void 0===e||null===e||""===e?(u=e=null,q="last",v=c.p.tree_root_level,t=c.p.data.length+1):(q="after",n=c.p._index[e],s=c.p.data[n],e=s[c.p.localReader.id],v=parseInt(s[k],10)+1,t=a(c).jqGrid("getFullTreeNode",s),t.length?(u=t=t[t.length-1][c.p.localReader.id],t=a(c).jqGrid("getInd",u)+1):t=a(c).jqGrid("getInd",e)+1,s[g]&&(x=!0,s[h]=!0,a(c.rows[z]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(c.p.treeIcons.leaf+
" tree-leaf").addClass(c.p.treeIcons.minus+" tree-minus"),c.p.data[n][g]=!1,s[r]=!0));n=t+1;void 0===b[h]&&(b[h]=!1);void 0===b[r]&&(b[r]=!1);b[k]=v;void 0===b[g]&&(b[g]=!0);"adjacency"===c.p.treeGridModel&&(b[l]=e);if("nested"===c.p.treeGridModel){var w;if(null!==e){g=parseInt(s[p],10);k=a.jgrid.from(c.p.data);k=k.greaterOrEquals(p,g,{stype:"integer"});k=k.select();if(k.length)for(w in k)k.hasOwnProperty(w)&&(k[w][m]=k[w][m]>g?parseInt(k[w][m],10)+2:k[w][m],k[w][p]=k[w][p]>=g?parseInt(k[w][p],10)+
2:k[w][p]);b[m]=g;b[p]=g+1}else{g=parseInt(a(c).jqGrid("getCol",p,!1,"max"),10);k=a.jgrid.from(c.p.data).greater(m,g,{stype:"integer"}).select();if(k.length)for(w in k)k.hasOwnProperty(w)&&(k[w][m]=parseInt(k[w][m],10)+2);k=a.jgrid.from(c.p.data).greater(p,g,{stype:"integer"}).select();if(k.length)for(w in k)k.hasOwnProperty(w)&&(k[w][p]=parseInt(k[w][p],10)+2);b[m]=g+1;b[p]=g+2}}if(null===e||a(c).jqGrid("isNodeLoaded",s)||x)a(c).jqGrid("addRowData",d,b,q,u),a(c).jqGrid("setTreeNode",t,n);s&&!s[h]&&
...
l+='<tr id="'+p+'"'+(k.groupCollapse&&0<w.idx?' style="display:none;" ':" ")+'role="row" class= "ui-widget-content jqgroup ui-row-'+g.p.direction+" "+r+'"><td style="padding-left:'+12*w.idx+'px;" colspan="'+e+'">'+m+a.jgrid.template(k.groupText[w.idx],n,w.cnt,w.summary)+"</td></tr>";if(v-1===w.idx){var H=k.groups[c+1],B,J=0;B=w.startRow;var D=void 0!==H?H.startRow:k.groups[c].startRow+k.groups[c].cnt;k._locgr&&(J=(b-1)*f,J>w.startRow&&(B=J));for(;B<D&&d[B-J];B++)l+=d[B-J].join("");if("header"!==k.groupSummaryPos[w.idx]){var y;
if(void 0!==H){for(y=0;y<k.groupField.length&&H.dataIndex!==k.groupField[y];y++);t=k.groupField.length-y}for(H=0;H<t;H++)u[H]&&(J="",k.groupCollapse&&!k.showSummaryOnHide&&(J=' style="display:none;"'),l+="<tr"+J+' jqfootlevel="'+(w.idx-H)+'" role="row" class="ui-widget-content jqfoot ui-row-'+g.p.direction+'">',l+=h(c,H,k.groups,0),l+="</tr>");t=y}}});a("#"+a.jgrid.jqID(g.p.id)+" tbody:first").append(l);l=null})},groupingGroupBy:function(d,e){return this.each(function(){"string"===typeof d&&(d=[d]);
...
10))?p:p+" ";g[p]=n}return e}function n(a){var b,c,d,e,g;for(d in a)if(a.hasOwnProperty(d)){if("object"!==typeof a[d]&&("level"===d&&(void 0===O[a.level]&&(O[a.level]="",0<a.level&&"_r_Totals"!==a.text&&(l[a.level-1]={useColSpanStyle:!1,groupHeaders:[]})),O[a.level]!==a.text&&a.children.length&&"_r_Totals"!==a.text&&0<a.level&&(l[a.level-1].groupHeaders.push({titleText:a.text}),c=l[a.level-1].groupHeaders.length,g=1===c?Y:Q+(c-1)*w,l[a.level-1].groupHeaders[c-1].startColumnName=f[g].name,l[a.level-
1].groupHeaders[c-1].numberOfColumns=f.length-g,Q=f.length),O[a.level]=a.text),a.level===z&&"level"===d&&0<z))if(1<w){c=1;for(b in a.fields)1===c&&l[z-1].groupHeaders.push({startColumnName:b,numberOfColumns:1,titleText:a.text}),c++;l[z-1].groupHeaders[l[z-1].groupHeaders.length-1].numberOfColumns=c-1}else l.splice(z-1,1);null!=a[d]&&"object"===typeof a[d]&&n(a[d]);if("level"===d&&0<a.level)for(b in c=0,a.fields){g={};for(e in m.aggregates[c])if(m.aggregates[c].hasOwnProperty(e))switch(e){case "member":case "label":case "aggregator":break;
default:g[e]=m.aggregates[c][e]}1<w?(g.name=b,g.label=m.aggregates[c].label||b):(g.name=a.text,g.label="_r_Totals"===a.text?m.rowTotalsText:a.text);f.push(g);c++}}}var s,v,t,u=e.length,x,z,w,A,H=0;m.rowTotals&&0<m.yDimension.length&&(m.yDimension.splice(0,0,{dataName:m.yDimension[0].dataName}),m.yDimension[0].converter=function(){return"_r_Totals"});x=a.isArray(m.xDimension)?m.xDimension.length:0;z=m.yDimension.length;w=a.isArray(m.aggregates)?m.aggregates.length:0;if(0===x||0===w)throw"xDimension or aggregates optiona are not set!";
var B;for(t=0;t<x;t++)B={name:m.xDimension[t].dataName,frozen:m.frozenStaticCols},null==m.xDimension[t].isGroupField&&(m.xDimension[t].isGroupField=!0),B=a.extend(!0,B,m.xDimension[t]),f.push(B);B=x-1;for(var J={};H<u;){s=e[H];var D=[],y=[];A={};t=0;do D[t]=a.trim(s[m.xDimension[t].dataName]),A[m.xDimension[t].dataName]=D[t],t++;while(t<x);var F=0;v=-1;t=b(c,r,D);if(!t){F=0;if(1<=z){for(F=0;F<z;F++)y[F]=a.trim(s[m.yDimension[F].dataName]),m.yDimension[F].converter&&a.isFunction(m.yDimension[F].converter)&&
(y[F]=m.yDimension[F].converter.call(this,y[F],D,y));A=q(s,m.aggregates,y,A)}else 0===z&&(A=q(s,m.aggregates,null,A));c.push(A)}else if(0<=v){F=0;if(1<=z){for(F=0;F<z;F++)y[F]=a.trim(s[m.yDimension[F].dataName]),m.yDimension[F].converter&&a.isFunction(m.yDimension[F].converter)&&(y[F]=m.yDimension[F].converter.call(this,y[F],D,y));t=q(s,m.aggregates,y,t)}else 0===z&&(t=q(s,m.aggregates,null,t));c[v]=t}s=0;var D=A=null,C;for(C in g){if(0===s)J.children&&void 0!==J.children||(J={text:C,level:0,children:[]}),
A=J.children;else{D=null;for(t=0;t<A.length;t++)if(A[t].text===C){D=A[t];break}D?A=D.children:(A.push({children:[],text:C,level:s,fields:g[C]}),A=A[A.length-1].children)}s++}H++}var O=[],Q=f.length,Y=Q;0<z&&(l[z-1]={useColSpanStyle:!1,groupHeaders:[]});n(J,0);if(m.colTotals)for(H=c.length;H--;)for(t=x;t<f.length;t++)u=f[t].name,h[u]=h[u]?h[u]+parseFloat(c[H][u]||0):parseFloat(c[H][u]||0);if(0<B)for(t=0;t<B;t++)f[t].isGroupField&&(k.groupingView.groupField.push(f[t].name),k.groupingView.groupSummary.push(m.groupSummary),
...
e?{userdata:d.summary}:{}),datatype:"jsonstring",footerrow:e,userDataOnFooter:e,colModel:d.colModel,viewrecords:!0,sortname:b.xDimension[0].dataName},f||{},d.groupOptions));d=d.groupHeaders;if(d.length)for(c=0;c<d.length;c++)d[c]&&d[c].groupHeaders.length&&jQuery(g).jqGrid("setGroupHeaders",d[c]);b.frozenStaticCols&&jQuery(g).jqGrid("setFrozenColumns")}var g=this;"string"===typeof d?a.ajax(a.extend({url:d,dataType:"json",success:function(b){h(a.jgrid.getAccessor(b,c&&c.reader?c.reader:"rows"))}},
c||{})):h(d)})}})})(jQuery);
