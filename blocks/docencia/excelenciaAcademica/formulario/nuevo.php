...
$items=array("tabExcelenciaConsultar"=>$this->lenguaje->getCadena("tabExcelenciaConsultar"),"tabExcelenciaCrear"=>$this->lenguaje->getCadena("tabExcelenciaCrear") );
...
$atributos["id"]="tabExcelenciaCrear";
$atributos["estilo"]="";
echo $this->miFormulario->division("inicio",$atributos);
...
$atributos["id"]="tabExcelenciaConsultar";
$atributos["estilo"]="";
echo $this->miFormulario->division("inicio",$atributos);
