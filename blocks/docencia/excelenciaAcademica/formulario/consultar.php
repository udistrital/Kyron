...
$cadena_sql = $this->sql->cadena_sql("consultarExcelencia", $arreglo);
...
if ($resultadoTitulos) {
    ...
    for ($i = 0; $i < count($resultadoTitulos); $i ++) {
        ...
        $variable.= "&excelencia_idserial=".$resultadoTitulos[$i][3];
        ...
        $mostrarHtml = "<tr>
                    ...
                    <td><center>" . $resultadoTitulos [$i] [1] . " " . $resultadoTitulos [$i] [2] . "</center></td>
