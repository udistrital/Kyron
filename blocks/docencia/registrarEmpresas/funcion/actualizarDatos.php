...
if (! isset ( $GLOBALS ["autorizado"] )) {
	...
	$arregloDatos = array($_REQUEST['idEmpresa'],
	...
	$estaLinea = $this->cadena_sql = $this->sql->cadena_sql("actualizarEmpresa", $arregloDatos);
	...
	if ($resultadoEmpresa) {
		$this->funcion->redireccionar ( 'Actualizo', $_REQUEST ['idEmpresa'] );
	} else {
		$this->funcion->redireccionar ( 'noActualizo', $_REQUEST ['idEmpresa'] );
	}
}
?>