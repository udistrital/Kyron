...
class SqlregistrarEmpresas extends sql {
	var $miConfigurador;
	...
	function cadena_sql($tipo, $variable = "") {
		...
		switch ($tipo) {
			...
			case "insertarEmpresa" :
				...
				$cadena_sql = "INSERT INTO docencia.registrar_empresa( ";
				$cadena_sql .= "id_docente, nombrempresa, campoeconomico, camaracomercio, registrarnit,  ";
				$cadena_sql .= "codigoinstitucional, campotecnologico, numacta, ";
				$cadena_sql .= "fechacta, numcaso, puntaje )";
			...
			case "consultarTecnologia" :
				
				$cadena_sql = "SELECT DISTINCT ";
				$cadena_sql .= "nombrempresa, campoeconomico, registrarnit, camaracomercio,  ";
				$cadena_sql .= "codigoinstitucional, campotecnologico, numacta,  ";
				$cadena_sql .= "numcaso, puntaje, fechacta  ";
				$cadena_sql .= "FROM docencia.registrar_empresa ";
				$cadena_sql .= "WHERE empresaid =" . $variable;
				
				break;
			
			case "consultarEmpresa" :
				
				$cadena_sql = "SELECT nombrempresa, campoeconomico, registrarnit, camaracomercio,";
				$cadena_sql .= "codigoinstitucional, campotecnologico, numacta, numcaso, puntaje,fechacta,";
				$cadena_sql .= "informacion_nombres, informacion_apellidos,id_docente,empresaid ";
				...
				$cadena_sql .= "JOIN docencia.registrar_empresa ON id_docente = dependencia_iddocente	 ";
			...
			case "actualizarEmpresa" :
				$cadena_sql = "UPDATE ";
				$cadena_sql .= "docencia.registrar_empresa ";
				$cadena_sql .= "SET ";
				$cadena_sql .= "nombrempresa = '" . $variable [1] . "', ";
				$cadena_sql .= "campoeconomico = '" . $variable [2] . "', ";
				$cadena_sql .= "registrarnit = '" . $variable [3] . "', ";
				$cadena_sql .= "camaracomercio = '" . $variable [4] . "', ";
				$cadena_sql .= "codigoinstitucional = '" . $variable [5] . "', ";
				$cadena_sql .= "campotecnologico = '" . $variable [6] . "', ";
				$cadena_sql .= "numacta = '" . $variable [7] . "', ";
				$cadena_sql .= "fechacta = '" . $variable [8] . "', ";
				$cadena_sql .= "numcaso = '" . $variable [9] . "', ";
				$cadena_sql .= "puntaje = '" . $variable [10] . "' ";
				$cadena_sql .= "WHERE ";
				$cadena_sql .= "empresaid ='" . $variable [0] . "' ";
				break;
			/**
			 * Clausulas genéricas.
