...
class FuncionestadoDocente {
		...
		if ((! isset ( $_REQUEST ["solicitud"] ) && ! isset ( $_REQUEST ["procesarAjax"] )) || (isset ( $_REQUEST [""] ) && ($_REQUEST ["solicitud"] == "nuevo" || $_REQUEST ["solicitud"] == "editar"))) {
			...
			if (isset ( $_REQUEST ["procesarAjax"] )) {
				...
				if ($_REQUEST ["solicitud"] == "confirmar") {
					$this->confirmar ();
				}elseif ($_REQUEST ["solicitud"] == "procesarMostrarInfoDocente" && isset ( $_REQUEST ["botonCambiarEstado"] ) && $_REQUEST ["botonCambiarEstado"] == 'true') {
					
					$this->procesarMostrarInfoDocente ( $_REQUEST ['datos'] );
				}elseif ($_REQUEST ["solicitud"] == "procesarMostrarInfoDocente" && isset ( $_REQUEST ["botonModificarEstado"] ) && $_REQUEST ["botonModificarEstado"] == 'true') {
					
					$this->procesarMostrarInfoDocenteModificar ( $_REQUEST ['datos'] );
				...
				elseif ($_REQUEST ["solicitud"] == "procesarEditarEstado") {
					...
					$this->procesarEditarEstado ( $_REQUEST ['datos'] );
	...
	function procesarEditarEstado($datos) {
