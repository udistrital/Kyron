...
$objPHPExcel->getActiveSheet ()->getStyle ( 'A6:G6' )->getFont ()->setSize ( 14 );
$objPHPExcel->setActiveSheetIndex ( 0 )->getRowDimension ( '0' )->setRowHeight ( 100 );
...
$objPHPExcel->setActiveSheetIndex ( 0 )->setCellValue ( 'A6', 'Nombre Docente' )->setCellValue ( 'B6', 'Estado Docente' )->setCellValue ( 'C6', 'Estado Complementario' )->setCellValue ( 'D6', 'Nombre archivo Soporte' )->setCellValue ( 'E6', 'Fecha Inicio de Estado' )->setCellValue ( 'F6', 'Fecha Terminación de Estado' )->setCellValue ( 'G6', 'Fecha Registro Estado' );
