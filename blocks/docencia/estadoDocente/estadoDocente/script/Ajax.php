...
// // ----------------------jqGrid-------------------------------------------------------------
// include_once($ruta."/script/scriptAjax/AjaxJqGrid.php");

// //-----------------------Autocomplete Widget -----------------------------------------------
// include_once ($ruta."/script/scriptAjax/autocomplete.php");

//---------------------------Mis Scrip javascript------------------------------------
include_once($ruta."/script/scriptAjax/MiScriptAjax.php");
