...
if(class_exists('BloqueestadoDocente') === false){
	class BloqueestadoDocente implements Bloque
	{
		...
		public function bloque(){
			...
			if(isset($_REQUEST['botonCancelar'])&&$_REQUEST['botonCancelar']=="true" or isset($_REQUEST['botonVolver'])&&$_REQUEST['botonVolver']=="true"or isset($_REQUEST['volver'])&&$_REQUEST['volver']=="true"){
