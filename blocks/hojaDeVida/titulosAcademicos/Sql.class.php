	...
	function getCadenaSql($tipo, $variable = "") {
		...
		switch ($tipo) {
			...
			case "registrar" :
				...
				$valor = $variable ['resolucion'];
				$variable ['resolucion'] = ($valor=='')?'NULL':" '".$valor."'";
				$cadenaSql.=" " . $variable['resolucion']. ",";
				$valor = $variable ['fechaResolucion'];
				$variable ['fechaResolucion'] = ($valor=='')?'NULL':" '".$valor."'";
				$cadenaSql.=" " . $variable['fechaResolucion']. ",";
				$valor = $variable ['entidadConvalidacion'];
				$variable ['entidadConvalidacion'] = ($valor=='')?'NULL':" '".$valor."'";
