...
<center>
	<table width='100%'>
		...
		<tr>
			...
			<td>Código</td>
			<td colspan='1'><?php echo $this -> atributos['datos_docente']['codigo_docente']; ?></td>
		</tr>
		<tr>
			<td>Proyecto</td>
...
<center>
	<table width='100%'>
		...
		<tr>
			<th style='font-size: 12px' colspan='9'>Jefe(a) Oficina de Docencia </th>
		</tr>
	</table>
	<p style='font-size: 9px'>
		Fecha Generación: <?php echo date("Y/m/d"); ?>
	</p>
</center>
