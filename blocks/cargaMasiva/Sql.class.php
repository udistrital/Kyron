...
class Sql extends \Sql {
	...
	function getCadenaSql($tipo, $variable = "") {
		...
		switch ($tipo) {
			...
			case "buscarExperienciaCalificada":
			    $cadenaSql="SELECT * FROM docencia.experiencia_calificada ";
			    $cadenaSql.=" WHERE ";
			    $cadenaSql.=" documento_docente='".$variable['documento_docente']."' ";
			    $cadenaSql.=" AND id_tipo_experiencia_calificada=( ";
			    $cadenaSql.=" SELECT id_tipo_experiencia_calificada ";
			    $cadenaSql.=" FROM docencia.tipo_experiencia_calificada ";
			    $cadenaSql.=" WHERE descripcion='".$variable['tipo_experiencia_calificada']."' ";
			    $cadenaSql.=" ) ";
			    $cadenaSql.=" AND annio_experiencia='".$variable['annio_experiencia']."' ";
			    $cadenaSql.=" AND numero_resolucion='".$variable['numero_resolucion']."' ";
			    $cadenaSql.=" AND id_tipo_emisor_resolucion=( ";
			    $cadenaSql.=" SELECT id_tipo_emisor_resolucion ";
			    $cadenaSql.=" FROM docencia.tipo_emisor_resolucion ";
			    $cadenaSql.=" WHERE descripcion='".$variable['tipo_emisor_resolucion']."' ";
			    $cadenaSql.=" ) ";
			    $cadenaSql.=" AND fecha_resolucion='".$variable['fecha_resolucion']."' ";
			    $cadenaSql.=" AND numero_acta='".$variable['numero_acta']."' ";
			    $cadenaSql.=" AND fecha_acta='".$variable['fecha_acta']."' ";
			    $cadenaSql.=" AND puntaje='".$variable['puntaje']."' ";
			    $cadenaSql.=" AND normatividad='".$variable['normatividad']."' ";
			...
			case "insertarExperienciaCalificada":
			    ...
			    $cadenaSql.=" ) ";
			    $cadenaSql.=" , ";
			    $cadenaSql.=" '".$variable['annio_experiencia']."', ";
			    $cadenaSql.=" '".$variable['numero_resolucion']."', ";
			    $cadenaSql.=" ( ";
			    $cadenaSql.=" SELECT id_tipo_emisor_resolucion ";
			    $cadenaSql.=" FROM docencia.tipo_emisor_resolucion ";
			    $cadenaSql.=" WHERE descripcion='".$variable['tipo_emisor_resolucion']."' ";
			    $cadenaSql.=" ) ";
			    $cadenaSql.=" , ";
			    $cadenaSql.=" '".$variable['fecha_resolucion']."', ";
			    $cadenaSql.=" '".$variable['numero_acta']."', ";
			    $cadenaSql.=" '".$variable['fecha_acta']."', ";
			    $cadenaSql.=" '".$variable['puntaje']."', ";
			    $cadenaSql.=" '".$variable['normatividad']."', ";
			...
			case "buscarLibrosNoInvestigacion":
			    $cadenaSql="SELECT * FROM docencia.libro_docente ";
			    $cadenaSql.=" WHERE ";
			    $cadenaSql.=" documento_docente='".$variable['documento_docente']."' ";
			    $cadenaSql.=" AND titulo='".$variable['titulo']."' ";
			    $cadenaSql.=" AND id_tipo_libro=( ";
			    $cadenaSql.=" SELECT id_tipo_libro ";
			    $cadenaSql.=" FROM docencia.tipo_libro ";
			    $cadenaSql.=" WHERE tipo_libro='".$variable['tipo_libro']."' ";
			    $cadenaSql.=" ) ";
			    //$cadenaSql.=" AND id_universidad=NULL ";
			    $cadenaSql.=" AND codigo_isbn='".$variable['codigo_isbn']."' ";
			    $cadenaSql.=" AND anno_publicacion='".$variable['anno_publicacion']."' ";
			    $cadenaSql.=" AND numero_autores='".$variable['numero_autores']."' ";
			    $cadenaSql.=" AND numero_autores_ud='".$variable['numero_autores_ud']."' ";
			...
			case "insertarLibrosNoInvestigacion":
			...
			case "buscarLibrosInvestigacion":
			    $cadenaSql="SELECT * FROM docencia.libro_docente ";
			    $cadenaSql.=" WHERE ";
			    $cadenaSql.=" documento_docente='".$variable['documento_docente']."' ";
			    $cadenaSql.=" AND titulo='".$variable['titulo']."' ";
			    ...
			    $cadenaSql.=" SELECT id_tipo_libro ";
			    $cadenaSql.=" FROM docencia.tipo_libro ";
			    $cadenaSql.=" WHERE tipo_libro='Investigación' ";
			    $cadenaSql.=" ) ";
			    $cadenaSql.=" AND id_universidad=( ";
			    $cadenaSql.=" SELECT id_universidad ";
			    $cadenaSql.=" FROM docencia.universidad ";
			    $cadenaSql.=" WHERE nombre_universidad='".$variable['universidad']."' ";
			    $cadenaSql.=" ) ";
			    $cadenaSql.=" AND codigo_isbn='".$variable['codigo_isbn']."' ";
			    $cadenaSql.=" AND anno_publicacion='".$variable['anno_publicacion']."' ";
			    $cadenaSql.=" AND numero_autores='".$variable['numero_autores']."' ";
			...
			case "insertarLibrosInvestigacion":
			    $cadenaSql="INSERT INTO docencia.libro_docente ";
			    $cadenaSql.=" ( ";
			    $cadenaSql.=" documento_docente, ";
			    $cadenaSql.=" titulo, ";
			...
			case "buscarProduccionTecnicaYSoftware":
			    $cadenaSql="SELECT * FROM docencia.produccion_tecnicaysoftware ";
			    $cadenaSql.=" WHERE ";
			    $cadenaSql.=" documento_docente='".$variable['documento_docente']."' ";
			    $cadenaSql.=" AND nombre='".$variable['nombre']."' ";
			    $cadenaSql.=" AND id_tipo_tecnicaysoftware=( ";
			    $cadenaSql.=" SELECT id_tipo_tecnicaysoftware ";
			    $cadenaSql.=" FROM docencia.tipo_tecnicaysoftware ";
			    $cadenaSql.=" WHERE nombre='".$variable['tipo_tecnicaysoftware']."' ";
			    $cadenaSql.=" ) ";
			    $cadenaSql.=" AND numero_certificado='".$variable['numero_certificado']."' ";
			    $cadenaSql.=" AND anno_produccion='".$variable['anno_produccion']."' ";
			    $cadenaSql.=" AND numero_acta='".$variable['numero_acta']."' ";
			    $cadenaSql.=" AND fecha_acta='".$variable['fecha_acta']."' ";
			    $cadenaSql.=" AND numero_caso='".$variable['numero_caso']."' ";
			    $cadenaSql.=" AND puntaje='".$variable['puntaje']."' ";
			...
			case "insertarProduccionTecnicaYSoftware":
			    ...
			    $cadenaSql.=" '".$variable['anno_produccion']."', ";
			    $cadenaSql.=" '".$variable['numero_acta']."', ";
			    $cadenaSql.=" '".$variable['fecha_acta']."', ";
			    $cadenaSql.=" '".$variable['numero_caso']."', ";
			    $cadenaSql.=" '".$variable['puntaje']."', ";
			...
			case "buscarProduccionX":
			    break;
			    
			case "insertarProduccionX":
			    break;
